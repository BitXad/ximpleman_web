            ...
            if (inv != null){
                ...
                for (var i = 0; i < tamanio ; i++){
                    ...
                    if (categoria != inv[i]["categoria_nombre"]){
                        paracolspan = Number(6+totalalmacen);
                        ...
                        if(1 <= totalalmacen){
                            html += "<td class='text-right'>"+inv[i]['suc1']+"</td>";
                            total_saldo += Number(inv[i]['suc1']);
                        }
                        if(2 <= totalalmacen){
                            html += "<td class='text-right'>"+inv[i]['suc2']+"</td>";
                            total_saldo += Number(inv[i]['suc2']);
                        }
                        if(3 <= totalalmacen){
                            html += "<td class='text-right'>"+inv[i]['suc3']+"</td>";
                            total_saldo += Number(inv[i]['suc3']);
                        }
                        if(4 <= totalalmacen){
                            html += "<td class='text-right'>"+inv[i]['suc4']+"</td>";
                            total_saldo += Number(inv[i]['suc4']);
                        }
                        if(5 <= totalalmacen){
                            html += "<td class='text-right'>"+inv[i]['suc5']+"</td>";
                            total_saldo += Number(inv[i]['suc5']);
                        }
                        if(6 <= totalalmacen){
                            html += "<td class='text-right'>"+inv[i]['suc6']+"</td>";
                            total_saldo += Number(inv[i]['suc6']);
                        }
                        if(7 <= totalalmacen){
                            html += "<td class='text-right'>"+inv[i]['suc7']+"</td>";
                            total_saldo += Number(inv[i]['suc7']);
                        }
                        if(8 <= totalalmacen){
                            html += "<td class='text-right'>"+inv[i]['suc8']+"</td>";
                            total_saldo += Number(inv[i]['suc8']);
                        }
                        if(9 <= totalalmacen){
                            html += "<td class='text-right'>"+inv[i]['suc9']+"</td>";
                            total_saldo += Number(inv[i]['suc9']);
                        }
                        if(10 <= totalalmacen){
                            html += "<td class='text-right'>"+inv[i]['suc10']+"</td>";
                            total_saldo += Number(inv[i]['suc10']);
                        }
                        html += "<td class='text-right'>"+total_saldo+"</td>";
                        //html += "<td>"+total_saldobs+"</td>";
                        eltotal_saldo += Number(total_saldo);
                        //html += "<td>"+losalmacenes[j]['almacen_nombre']+"</th>";
                        /*for (var j = 0; j < totalalmacen; j++) {
                            html += "<td>"+inv[i['almacen_nombre']+"</th>";
                        }*/
                        /*
...
//                html += "	<th></th>";
                ...
                html += "	<th></th>";
                html += "	<th class='text-right'>"+formato_numerico(eltotal_saldo)+"</th>";
                //html += "	<th></th>";
                /*html += "	<th></th>";
                html += "	<th></th>";*/
                html += "</tr>    ";
