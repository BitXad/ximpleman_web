               ...
               if (registros != null){                   
                    ...
                    for (var i = 0; i < n ; i++){
                       // var suma = Number(registros[i]["detallecomp_total"]);
                        ...
                        html += " <a href='"+base_url+"factura/imprimir_factura_id/"+registros[i]['factura_id']+"' target='_blank' class='btn btn-primary btn-xs' title='VER DETALLE VENTA'><span class='fa fa-file'></span></a>";
