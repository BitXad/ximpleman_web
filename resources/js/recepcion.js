           ...
           success:function(resul){     
               ...
               if (ventas != null){
               	...
               	for (var i = 0; i < n ; i++){
                        ...
                        html += "<td>"+(i+1)+"</td>";
                        html += "<td><b>"+ventas[i]["cliente_nombre"]+"</b></td>";
                        html += "<td>";
                for (var e = 0; e < d; e++) {
                	if (ventas[i]["venta_id"]==detalle[e]["venta_id"]) {
                        html += "<b>"+detalle[e]["detalleven_cantidad"]+"</b> ";	
                        html += " <b>"+detalle[e]["producto_nombre"]+"</b><br>";	
                        }        
                      }
                        ...
                        html += "    Despachar el Pedido <b># "+ventas[i]["venta_id"]+"?</b>";
                        html += "</h3>";
                        html += "<!------------------------------------------------------------------->";
                        html += "</div>";
