        ...
        success: function (respuesta) {
            ...
            if (registros != null) {
                ...
                for (var i = 0; i < x; i++) {
                    ...
                    html += "<td align='center' style='background: #" + registros[i]["estado_color"] + "'>" + (i + 1) + "</td>";
                    html += "<td align='center' style='background: #" + registros[i]["estado_color"] + "'><font size='3'><b>" + registros[i]["proveedor_nombre"] + "</b></font><font size='1'>[" + registros[i]["proveedor_id"] + "]</font><br>";
        ...
        success: function (resul) {
            ...
            if (registros != null) {
                ...
                for (var i = 0; i < x; i++) {
                    ...
                    html += "</td><td align='center' style='background: #" + registros[i]["estado_color"] + "'><font size='3'><b>" + registros[i]["compra_id"] + "</b></font></td>";
                    html += "<td align='right' style='background: #" + registros[i]["estado_color"] + "'> Subtotal:" + numberFormat(Number(registros[i]["compra_subtotal"]).toFixed(decimales)) + "<br>Desc: " + Number(registros[i]["compra_descuento"]).toFixed(decimales) + "<br> DescGlobal: " + Number(registros[i]["compra_descglobal"]).toFixed(decimales) + "<br>";
                    html += "<font size='3'><b>Total:" + numberFormat(Number(registros[i]["compra_totalfinal"]).toFixed(decimales)) + "</b></font></td>";
                    html += "<td style='text-align: center; background: #" + registros[i]["estado_color"] + "'>" + registros[i]['forma_nombre'] + "</td>"
                    html += "<td style='text-align: center; background: #" + registros[i]["estado_color"] + "'>" + (registros[i]['banco_nombre'] == null ? '' : registros[i]['banco_nombre']) + "</td>"
                    html += "<td  align='center' style='background: #" + registros[i]["estado_color"] + "'>" + convertDateFormat(registros[i]["compra_fecha"]) + "<br>" + registros[i]['compra_hora'] + "</td>";
                    ...
                    html += "<td style='background: #" + registros[i]["estado_color"] + "'>" + registros[i]["usuario_nombre"] + "</td>";
...
function mostrar_listabackupxxxx(bitacora_codigo, compra_id)
{
    var base_url = document.getElementById('base_url').value;
        ...
        success: function (respuesta) {
            ...
            if (res != null) {
                ...
                for (let i = 0; i < res.length; i++) {
                    ...
                    html += "<tr>";
                    html += "<td>" + res[i]["detallecomp_codigo"] + "</td><td>" + res[i]["detallecomp_codigo"] + "</td><td>" + res[i]["producto_nombre"] + "</td><td>" + Number(res[i]["detallecomp_costo"]) + "</td><td>" + res[i]["detallecomp_codigo"] + "</td>";
                    html += "</tr>";
                }
    ...
    $.ajax({url: controlador,
        ...
        success: function (respuesta) {
            ...
            for (var i = 0; i < res2.length; i++) {
                ...
                html += "<td " + estilo + ">" + (i + 1) + "</td>";
                html += "<td " + estilo + ">" + cambiar_formatofecha(res2[i]["fecha_bitacora"]) + " ** " + res2[i]["usuario_nombre"];
                html += " <button class='btn btn-warning btn-xs' type='button' ";
                html += "id='boton_productos_" + res2[i]["codigo_bitacora"] + "' ";
                html += "title='Ver lista de productos' ";
                html += "onclick='mostrar_listabackup(" + JSON.stringify(res2[i]["codigo_bitacora"]) + "," + res2[i]["compra_id"] + ")'>";
                html += "<fa class='fa fa-binoculars'></fa> </button>";
                html += "<span id='listaprod" + res2[i]["codigo_bitacora"] + "' style='display:block; margin-top:4px;'></span>";
                html += "</td>";
...
{
    let contenedor = $("#listaprod" + bitacora_codigo);
    let boton = $("#boton_productos_" + bitacora_codigo);

    if (contenedor.is(":visible") && $.trim(contenedor.html()) !== "") {
        contenedor.slideUp(200, function () {
            contenedor.html("");
            boton.html("<fa class='fa fa-binoculars'></fa>");
            boton.attr("title", "Ver lista de productos");
        });
        return;
    }
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if (res != null && res.length > 0) {
                html += "<table class='mi-tabla' style='margin-top:5px; border-collapse: collapse; width: 100%;'>";
                html += "<tr>";
                html += "<th style='border:1px solid #000; padding:4px;'>#</th>";
                html += "<th style='border:1px solid #000; padding:4px;'>COD</th>";
                html += "<th style='border:1px solid #000; padding:4px;'>PRODUCTO</th>";
                html += "<th style='border:1px solid #000; padding:4px;'>COSTO</th>";
                html += "<th style='border:1px solid #000; padding:4px;'>CANT.</th>";
                html += "<th style='border:1px solid #000; padding:4px;'>TOTAL</th>";
                html += "</tr>";

                for (let i = 0; i < res.length; i++) {
                    html += "<tr style='font-size: 9px;'>";
                    html += "<td style='border:1px solid #000; padding:4px;'>" + (i + 1) + "</td>";
                    html += "<td style='border:1px solid #000; padding:4px;'>" + res[i]["detallecomp_codigo"] + "</td>";
                    html += "<td style='border:1px solid #000; padding:4px;'>" + res[i]["producto_nombre"] + "</td>";
                    html += "<td style='border:1px solid #000; padding:4px; text-align:right;'>" + Number(res[i]["detallecomp_costo"]).toFixed(2) + "</td>";
                    html += "<td style='border:1px solid #000; padding:4px; text-align:right;'>" + Number(res[i]["detallecomp_cantidad"]).toFixed(2) + "</td>";
                    html += "<td style='border:1px solid #000; padding:4px; text-align:right;'>" + Number(res[i]["detallecomp_total"]).toFixed(2) + "</td>";
                    html += "</tr>";
                }

                html += "</table>";
            } else {
                html = "<div style='margin-top:5px; font-size:11px; color:#b94a48;'><b>No existen productos en este respaldo.</b></div>";
            }

            contenedor.hide().html(html).slideDown(200);
            boton.html("<fa class='fa fa-eye-slash'></fa>");
            boton.attr("title", "Ocultar lista de productos");
        }
    });
}


function exportar_excel_filtrado() {

    if (!compras_excel || compras_excel.length === 0) {
        alert("No hay datos para exportar. Primero realice una búsqueda.");
        return;
    }

    var decimales = document.getElementById('decimales').value || 2;
    ...
    html += "<th>#</th>";
    html += "<th>PROVEEDOR</th>";
    html += "<th>NRO. COMPRA</th>";
    html += "<th>SUB TOTAL</th>";
    html += "<th>DESCUENTO</th>";
    html += "<th>DESC. GLOBAL</th>";
    html += "<th>TOTAL</th>";
    ...
    for (var i = 0; i < compras_excel.length; i++) {

        var c = compras_excel[i];

        var subtotal = Number(c.compra_subtotal || 0);
        var descuento = Number(c.compra_descuento || 0);
        var descglobal = Number(c.compra_descglobal || 0);
        var total = Number(c.compra_totalfinal || 0);

        total_general += total;

        html += "<tr>";
        html += "<td>" + (i + 1) + "</td>";
        html += "<td>" + limpiar_excel(c.proveedor_nombre) + "</td>";
        html += "<td>" + limpiar_excel(c.compra_id) + "</td>";
        html += "<td>" + subtotal.toFixed(decimales) + "</td>";
        html += "<td>" + descuento.toFixed(decimales) + "</td>";
        html += "<td>" + descglobal.toFixed(decimales) + "</td>";
        html += "<td>" + total.toFixed(decimales) + "</td>";
        html += "<td>" + limpiar_excel(c.forma_nombre) + "</td>";
        html += "<td>" + limpiar_excel(c.banco_nombre) + "</td>";
        html += "<td>" + formato_fecha_excel(c.compra_fecha) + "</td>";
        html += "<td>" + limpiar_excel(c.compra_hora) + "</td>";
        html += "<td>" + limpiar_excel(c.estado_descripcion) + "</td>";
        html += "<td>" + limpiar_excel(c.usuario_nombre) + "</td>";
        html += "</tr>";
    }

    html += "<tr>";
    html += "<td colspan='6' align='right'><b>TOTAL GENERAL</b></td>";
    html += "<td><b>" + total_general.toFixed(decimales) + "</b></td>";
    ...
    enlace.download = "compras_" + fecha_nombre_excel() + ".xls";
...
function formato_fecha_excel(fecha) {
...
function fecha_nombre_excel() {
    var f = new Date();
    var y = f.getFullYear();
    var m = ("0" + (f.getMonth() + 1)).slice(-2);
    var d = ("0" + f.getDate()).slice(-2);
    var h = ("0" + f.getHours()).slice(-2);
    var min = ("0" + f.getMinutes()).slice(-2);
...
//        html += '<td><button type="button" class="btn btn-xs btn-primary" onclick="abrir_buscador_producto_xml(' + it.detalle_id + ',\'' + limpiar_js_xml(it.descripcion) + '\')"><i class="fa fa-chain"></i> Seleccionar</button>';
        html += '<td><button type="button" class="btn btn-xs btn-primary" onclick="abrir_buscador_producto_xml(' + it.detalle_id + ',\'' + limpiar_js_xml(it.codigoproducto) + '\',\'' + limpiar_js_xml(it.descripcion) + '\')"><i class="fa fa-chain"></i> Seleccionar</button>';
        
        
        if(limpiar_html_xml(it.producto_nombre_bd || '') != '' ){
            
            if(it.codigoproducto == it.producto_codigo){            
                html += '<button type="button" class="btn btn-xs btn-danger" onclick="desenlazar_productocodigo(' + it.producto_id + ',\'' + limpiar_js_xml(it.codigoproducto) + '\')" title="Quita la relación del producto proveedor con el del inventario"><i class="fa fa-random"></i> </button></td>';
            }else{            
                html += '<button type="button" class="btn btn-xs btn-facebook" onclick="enlazar_productocodigo(' + it.producto_id + ',\'' + limpiar_js_xml(it.codigoproducto) + '\')" title="Relacionará el código de producto con el código del proveedor para futuras compras"><i class="fa fa-compress"></i> </button></td>';
            }
        ...
        total_final += Number(it.subtotal);
        
    }
        html += '<tr>';
    
            html += '<th colspan=10>TOTALES</th>';
            html += '<th>' + Number(total_final || 0).toFixed(dec) + '</th>';
            html += '<th></th>';
            html += '<th></th>';
            html += '<th></th>';
            html += '<th></th>';
...
function abrir_buscador_producto_xml(detalle_id, codigo, descripcion) {
    $('#xml_detalle_id_producto').val(detalle_id);
    $('#nombre_producto').text(descripcion || '');
    $('#buscar_producto_xml').val(codigo || '');
    ...
    $.ajax({
        ...
        success: function (r) {
            ...
            for (var i = 0; i < r.length; i++) {
                ...
                html += '<td><b>' + limpiar_html_xml(r[i].producto_nombre)+' ('+limpiar_html_xml(r[i].producto_codigo) + ')</b></td>';
                html += '<td>' + limpiar_html_xml(r[i].producto_codigobarra) + '</td>';
                html += '<td>' + limpiar_html_xml(Number(r[i].producto_ultimocosto).toFixed(2)) + '</td>';
                html += '<td>' + limpiar_html_xml(r[i].producto_unidad) + '</td>';
                html += '<td><button type="button" class="btn btn-xs btn-facebook" onclick="vincular_producto_xml(' + r[i].producto_id + ')"><i class="fa fa-check"></i> Seleccionar</button>';
                html += "<a href='"+base_url+"/producto/edit/"+r[i].producto_id+"' class='btn btn-xs btn-primary' target='_blank' title='Modificar datos del producto'><i class='fa fa-edit'></i> </button></td>";
                html += '</tr>';
            }
...
function enlazar_productocodigo(producto_id, codigo_proveedor) {

    //var parametro = $('#buscar_producto_xml').val();
    //alert(producto_id+" *** "+codigo_proveedor);
    $.ajax({
        url: base_url + 'compra/enlazar_productocodigo',
        type: 'POST',
        data: {producto_id: producto_id, codigo_proveedor:codigo_proveedor},
        dataType: 'json',
        success: function (res) {
            ...
            if (result) {
                ...
                alert("Producto enlazado con éxito...!");
            } else {
                alert("ADVERTENCIA: No se pudo enlazar el producto...!");
            }
...
function desenlazar_productocodigo(producto_id, codigo_proveedor) {

    //var parametro = $('#buscar_producto_xml').val();
    //alert(producto_id+" *** "+codigo_proveedor);
    $.ajax({
        url: base_url + 'compra/desenlazar_productocodigo',
        type: 'POST',
        data: {producto_id: producto_id, codigo_proveedor:codigo_proveedor},
        dataType: 'json',
        success: function (res) {
            ...
            if (result) {
                recargar_detalle_factura_xml();
                alert("Se quitó en enlace con el producto correctamente...!");
            } else {
                alert("ADVERTENCIA: No se pudo quitar el enlace con el producto...!");
            }
