                ...
                for (var i = 0; i < tamanio ; i++){
                    ...
                    /*if (categoria != inv[i]["categoria_nombre"]){                        
                        ...
                        html += "<tr "+margen+">";
                                    ...
                                    total = Number(inv[i]["compras"]-inv[i]["vetnas"]); 
                                    /*total_final += total;
                                    existencia = parseFloat(inv[i]["existencia"]);
                                    */
                        html += "             	<td "+margen+">"+(i+1)+"</td>";
                        html += "             	<td "+margen+"><font size='0.5'>"+ inv[i]["producto_nombre"]+"</font>";
                        html += "             	<td "+margen+" style='background: red'><center><font size='1'>"+inv[i]["producto_nombre"]+"</font> </center></td>";
                        html += "             	<td "+margen+" style='background: red'><center><font size='1'>"+inv[i]["clasificador_nombre"]+"</font> </center></td>";
                        html += "             	<td "+margen+"><center> <font size='1'><b>"+ total+"</b></font></center></td>";
