...
//                $this->db->query($sql);
        ...
        $sql = "select * from detalle_factura_servicios where exento_detfact <> 'NO' and id_fact = {$id_fact} ";
