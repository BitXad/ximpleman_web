...
class Encomienda_model extends CI_Model
{
    ...
    function entregar($id,$params,$usuario_id){
        $params['encomiendaestado_id']=7; $params['encomienda_fechaentrega']=date('Y-m-d H:i:s');
        $this->update_encomienda($id,$params);
        $this->add_movimiento(array('encomienda_id'=>$id,'usuario_id'=>$usuario_id,'encomiendaestado_id'=>7,'movimientoencomienda_accion'=>'Entrega confirmada','movimientoencomienda_observacion'=>'Recibe: '.$params['encomienda_nombre_recibe']));
    }
