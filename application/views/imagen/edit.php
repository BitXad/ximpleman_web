<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('imagen/edit/'.$imagen['imagen_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="estadopag_id" class="form-control">
								...
								{
									$selected = ($estado_pagina['estadopag_id'] == $imagen['estadopag_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="articulo_id" class="form-control">
								...
								{
									$selected = ($articulo['articulo_id'] == $imagen['articulo_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="imagen_titulo" value="<?php echo ($this->input->post('imagen_titulo') ? $this->input->post('imagen_titulo') : $imagen['imagen_titulo']); ?>" class="form-control" id="imagen_titulo" required />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="imagen_nombre" value="<?php echo ($this->input->post('imagen_nombre') ? $this->input->post('imagen_nombre') : $imagen['imagen_nombre']); ?>" class="form-control" id="imagen_nombre" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="imagen_texto" class="control-label">Texto</label>
						<div class="form-group">
							<textarea name="imagen_texto" class="form-control" id="imagen_texto"><?php echo ($this->input->post('imagen_texto') ? $this->input->post('imagen_texto') : $imagen['imagen_texto']); ?></textarea>
						</div>
					</div>
				</div>
			</div>
