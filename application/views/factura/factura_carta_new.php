                    ...
                    <div style="display: inline-block; float:left; width:35%">
                        <table style="word-wrap: break-word; width: 100%; padding:0; border-bottom: #0000eb;">
                            ...
                            if ($factura[0]["docsec_codigoclasificador"]==13){ 
                                    ...
                                    if($datos_factura['datos_beneficiarioley1886']>0){
                                ?>
                            ...
                            <td colspan="1" style="padding: 0; line-height: 10px;"><font style="size:7px; font-family: arial; padding-left:3px">
                                    ...
                                    <?php 
                                        if ($factura[0]['docsec_codigoclasificador']==13){ 
                                            ...
                                            if ($datos_factura["datos_montodescuentoley1886"]>0){?> 
                                
                                                <br>Ley 1886 <?php echo number_format($datos_factura["datos_montodescuentoley1886"],$decimales,".",","); ?>
                                                <br>Tarifa Dignidad <?php echo number_format($datos_factura["datos_montodescuentotarifadignidad"],$decimales,".",","); ?>
...
<!--                        <tr>
                    ...
                    <?php if($factura[0]['docsec_codigoclasificador']==13){ 
                        ...
                        <tr>
                            ...
                            <td style="padding:0; padding-right: 3px;" align="right"><b><?= number_format($tasas ,$dos_decimales,'.',',') ?></b></td>
                        </tr>
