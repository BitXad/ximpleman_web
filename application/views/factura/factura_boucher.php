...
<?php if($venta[0]['venta_tipodoc']==1){ $titulo1 = "FACTURA"; $subtitulo = "ORIGINAL"; }
                ...
                <font size="1" face="arial"><b>ORIGINAL</b></font>
            </center>                      
        </td>
    </tr>
    ...
    <tr>
        ...
        <div class="panel panel-primary col-md-12">
            ...
            <center>                        
                <font size="1" face="arial"><?php echo $factura[0]['factura_actividad']?></font>

                <?php $fecha = new DateTime($venta[0]['venta_fecha']); 
      $fecha_d_m_a = $fecha->format('d/m/Y');
?>    

    <div class="panel panel-primary" style="width: 7cm;">
...
<link href="<?php echo base_url('resources/css/impresion.css'); ?>" rel="stylesheet">  
