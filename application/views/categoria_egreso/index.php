...
<div class="box-header">
    ...
    <div class="box-tools no-print">
        <a href="<?php echo site_url('categoria_egreso/add'); ?>" class="btn btn-success btn-sm">
        ...
        <div class="box">
            <div class="box-body table-responsive">
                <table class="table table-striped table-condensed" id="mitabla">
                    ...
                    <tbody class="buscar">
                        <?php $i = 1; foreach($categoria_egreso as $c){ ?>
                        <tr>
                            <td><?php echo $i; ?></td>
                            ...
                            <td class="no-print">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer aligncenter">
                                                <a href="<?php echo site_url('categoria_egreso/remove/'.$c['id_categr']); ?>" class="btn btn-success">
                                ...
                                <!-- Fin modal -->
                                <a href="<?php echo site_url('categoria_egreso/edit/'.$c['id_categr']); ?>" class="btn btn-info btn-xs" title="Editar">
