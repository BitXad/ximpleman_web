        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label>&nbsp;</label><br>
                        <button type="button" class="btn btn-success" onclick="subir_factura_xml()"><i class="fa fa-upload"></i> Cargar factura XML</button>
                    </div>
                    <div class="col-md-4">
                        <label>Estado</label>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background:#00a65a;color:white;">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><i class="fa fa-search"></i> Seleccionar producto</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="table-responsive" style="max-height:360px;overflow-y:auto;">
                    <table class="table table-bordered table-condensed table-striped">
                        <thead><tr><th>#</th><th>ID</th><th>Producto</th><th>Código</th><th>Cód. Barras</th><th>Unidad</th><th>Acción</th></tr></thead>
