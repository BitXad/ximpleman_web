...
function escapeRegExpCompra(texto) {
    return String(texto || '').replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
}
        $(document).ready(function () {
            (function ($) {
                $('#filtrar').keyup(function () {
                    var rex = new RegExp(escapeRegExpCompra($(this).val()), 'i');
                    $('.buscar tr').hide();
        ...
        <div class="box-body">
                <div class="row clearfix">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <input type="text" name="producto_nombre" autocomplete="off"
                                   value="<?php echo html_escape($this->input->post('producto_nombre')); ?>"
                                   onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);"
                                   class="form-control" id="producto_nombre" required/>
                            <small id="msg_producto_nombre" class="text-danger" style="display:none;">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <input type="text" name="producto_marca" autocomplete="off" onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" value="<?php echo html_escape($this->input->post('producto_marca')); ?>" class="form-control" id="producto_marca" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <input type="text" name="producto_codigobarra" autocomplete="off"
                                   onkeypress="return pulsar(event)"
                                   value="<?php echo html_escape($this->input->post('producto_codigobarra')); ?>"
                                   class="form-control" id="producto_codigobarra" required/>
                            <small id="msg_producto_codigobarra" class="text-danger" style="display:none;">
                                Este código de barra ya existe.
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <input type="text" name="producto_codigo" autocomplete="off"
                                   value="<?php echo html_escape($this->input->post('producto_codigo')); ?>"
                                   class="form-control" id="producto_codigo" />
                            <small id="msg_producto_codigo" class="text-danger" style="display:none;">
              ...
              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="" data-original-title="Collapse"><i class="fa fa-plus"></i></button>
                ...
                foreach($unidades as $u){ ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <input type="text" name="producto_industria" onKeyUp="this.value = this.value.toUpperCase();" value="<?php echo html_escape($this->input->post('producto_industria')); ?>" class="form-control" id="producto_industria" />
                        </div>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="box-body">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="proveedor_nombre" value="<?php echo html_escape($this->input->post('proveedor_nombre')); ?>" onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" class="form-control" id="proveedor_nombre1" required />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="proveedor_contacto" value="<?php echo html_escape($this->input->post('proveedor_contacto')); ?>"  onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" class="form-control" id="proveedor_contacto" />
                        </div>
                    </div>
            ...
            <div class="box-header with-border">
              ...
              <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="" data-original-title="Collapse"><i class="fa fa-plus"></i></button>
                    ...
                    <div class="col-md-6" >
                        ...
                        <div class="form-group">
                            <input type="text" id="proveedor_razon" class="form-control" onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" value="<?php echo html_escape($this->input->post('proveedor_razon')); ?>" class="form-control" />
                        </div>
                    </div>
                    <div class="col-md-6" >
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="proveedor_direccion" value="<?php echo html_escape($this->input->post('proveedor_direccion')); ?>" onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" class="form-control" id="proveedor_direccion" />
                        </div>
                    </div>
        ...
        <div class="box collapsed-box">
            <div class="box-header " style="border:0px; padding: 0px;">
              ...
              <div class="box-body" style="display: none;">
                                        ...
                                        NIT:
                                        <input type="text" id="proveedor_nit<?php echo $h['proveedor_id']; ?>" name="proveedor_nit" class="form-control" placeholder="N.I.T."  value="<?php echo html_escape($h['proveedor_nit']); ?>">
                                        <input id="bandera" class="form-control" name="bandera" type="hidden" value="<?php echo $bandera; ?>" />
                                        RAZON SOCIAL:
                                        <input type="text" id="proveedor_razon<?php echo $h['proveedor_id']; ?>" name="proveedor_razon" class="form-control" placeholder="Razón Social"  value="<?php echo html_escape($h['proveedor_razon']); ?>">
                                        COD. CONTROL:
                                        <input type="text" id="proveedor_codigo<?php echo $h['proveedor_id']; ?>" name="proveedor_codigo" class="form-control" placeholder="Codigo"  value="<?php echo html_escape($h['proveedor_codigo']); ?>" >
                                        AUTORIZACION:
                                        <input type="text" id="proveedor_autorizacion<?php echo $h['proveedor_id']; ?>" name="proveedor_autorizacion" class="form-control" placeholder="AUTORIZACION"  value="<?php echo html_escape($h['proveedor_autorizacion']); ?>" >
...
?>              
    ...
    <label for="compra_caja2">Generar orden de pago</label></span>
        ...
        <div class="box-body table-responsive table-condensed">
            ...
            <span class="btn btn-default">Actualizar precios de las sucursales <input  type="checkbox"  id="actualizarpreciossucursales" name="actualizarpreciossucursales" value="1"></span>
...
$(document).ready(function () {
    ...
    function validarDuplicadosProducto() {
        let base_url = $("#base_url").val();

        $.ajax({
            url: base_url + "producto/validar_duplicados_ajax",
            type: "POST",
            dataType: "json",
            data: {
                producto_nombre: $("#producto_nombre").val(),
                producto_codigobarra: $("#producto_codigobarra").val(),
                producto_codigo: $("#producto_codigo").val()
            },
            success: function (resp) {
                // limpiar estados
                $("#producto_nombre, #producto_codigobarra, #producto_codigo").css("border-color", "");
                $("#msg_producto_nombre, #msg_producto_codigobarra, #msg_producto_codigo").hide();

                if (resp.nombre) {
                    $("#producto_nombre").css("border-color", "red");
                    $("#msg_producto_nombre").show();
                }

                if (resp.codigobarra) {
                    $("#producto_codigobarra").css("border-color", "red");
                    $("#msg_producto_codigobarra").show();
                }

                if (resp.codigo) {
                    $("#producto_codigo").css("border-color", "red");
                    $("#msg_producto_codigo").show();
                }
            }
        });
    }

    $("#producto_nombre, #producto_codigobarra, #producto_codigo").on("keyup blur change", function () {
        validarDuplicadosProducto();
    });

    $("form").on("submit", function(e) {
        let existeError = false;

        if ($("#msg_producto_nombre").is(":visible")) existeError = true;
        if ($("#msg_producto_codigobarra").is(":visible")) existeError = true;
        if ($("#msg_producto_codigo").is(":visible")) existeError = true;

        if (existeError) {
            e.preventDefault();
            alert("Existen campos duplicados. Corrija los datos antes de guardar.");
        }
    });
