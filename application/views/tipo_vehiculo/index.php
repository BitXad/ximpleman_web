...
<script src="<?php echo base_url('resources/plugins/datatables.net-bs');  ?>/js/dataTables.bootstrap.min.js"></script>
 ...
 <script>
            ...
            <div class="box-header">
                <h3 class="box-title">Tipo Vehiculo</h3>
              <div class="box-tools">
   ...
   <?php //echo $this->session->flashdata('alert_msg');?>
            <div class="box-body table-responsive no-padding">
                <table id="mitabla" class="table table-striped">
                    ...
                    <tbody>
                    <?php $i=$noof_page+1; 
           if(isset($tipo_vehiculo) && $tipo_vehiculo!=null)
           {
           foreach($tipo_vehiculo as $t){ ?>
                    <tr>
                    <td><?php echo $i++; ?></td>
                    <!--<td><?php echo $t['tipomovilidad_id']; ?></td>-->
                    <td><?php echo $t['tipomovilidad_descripcion']."<sub>[".$t['tipomovilidad_id']."]</sub>"; ?></td>
                     <td><a href="<?php echo site_url('tipo_vehiculo/edit/'.$t['tipomovilidad_id']); ?>" class="btn btn-info btn-xs"><span class="fa fa-pencil"></span> </a> 
                         <a
                            onclick="return confirm('Are you sure You want to delete?')"
                             href="<?php echo site_url('tipo_vehiculo/remove/'.$t['tipomovilidad_id']); ?>" class="btn btn-danger btn-xs"><span class="fa fa-trash"></span> </a>
                     </td>
                    </tr>
                     <?php }
