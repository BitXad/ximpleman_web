    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Asientos Edit</h3>
            <?php echo form_open_multipart('asientos/edit/'.$asientos['asiento_id']); ?>
            <div class="box-body">
              <div class="row clearfix">
           <div class="col-md-6">
               <label for="asiento_id" class="control-label">  <span class="text-danger"></span>ID</label>
                <div class="form-group">
                  <input type="number" name="asiento_id" value="<?php echo ($this->input->post('asiento_id') ? $this->input->post('asiento_id') : $asientos['asiento_id']); ?>" class="form-control" id="asiento_id" />
            ...
            <div class="form-group">
              <select name="nivel_id" class="form-control">
                ...
                <?php  
                          ...
                          { 
                              $selected = ($nivel_vehiculo['nivel_id'] == $asientos['nivel_id']) ? ' selected="selected"' : "";
           ...
           <div class="col-md-6">
               <label for="asiento_numero" class="control-label">  <span class="text-danger"></span>NUMERO</label>
                <div class="form-group">
                  <input type="text" name="asiento_numero" value="<?php echo ($this->input->post('asiento_numero') ? $this->input->post('asiento_numero') : $asientos['asiento_numero']); ?>" class="form-control" id="asiento_numero" />
               ...
               <label for="asiento_descripcion" class="control-label">  <span class="text-danger"></span>DESCRIPCION</label>
                <div class="form-group">
                  <input type="text" name="asiento_descripcion" value="<?php echo ($this->input->post('asiento_descripcion') ? $this->input->post('asiento_descripcion') : $asientos['asiento_descripcion']); ?>" class="form-control" id="asiento_descripcion" />
               ...
               <label for="asiento_caracteristicas" class="control-label">  <span class="text-danger"></span>CARACTERISTICAS</label>
                <div class="form-group">
                  <input type="text" name="asiento_caracteristicas" value="<?php echo ($this->input->post('asiento_caracteristicas') ? $this->input->post('asiento_caracteristicas') : $asientos['asiento_caracteristicas']); ?>" class="form-control" id="asiento_caracteristicas" />
               ...
               <label for="asiento_foto" class="control-label">  <span class="text-danger"></span>FOTO</label>
                <div class="form-group">
                  <input type="file" name="asiento_foto" value="<?php echo ($this->input->post('asiento_foto') ? $this->input->post('asiento_foto') : $asientos['asiento_foto']); ?>" class="form-control" id="asiento_foto" />
                   <span class="text-danger"><?php echo form_error('asiento_foto');?></span>
               </div>
             </div>
               <div class="col-md-3">
                    <img width="100" height="100" src="<?php echo base_url('resource/asiento_foto/').$asientos['asiento_foto']; ?>">
             </div> 
             
           <div class="col-md-6">
               <label for="asiento_orden" class="control-label">  <span class="text-danger"></span>ORDEN</label>
                <div class="form-group">
                  <input type="number" name="asiento_orden" value="<?php echo ($this->input->post('asiento_orden') ? $this->input->post('asiento_orden') : $asientos['asiento_orden']); ?>" class="form-control" id="asiento_orden" />
               ...
               <label for="asiento_x" class="control-label">  <span class="text-danger"></span>POSICION COLUMNA</label>
                <div class="form-group">
                  <input type="number" name="asiento_x" value="<?php echo ($this->input->post('asiento_x') ? $this->input->post('asiento_x') : $asientos['asiento_x']); ?>" class="form-control" id="asiento_x" />
               ...
               <label for="asiento_y" class="control-label">  <span class="text-danger"></span>POSICION FILA</label>
                <div class="form-group">
                  <input type="number" name="asiento_y" value="<?php echo ($this->input->post('asiento_y') ? $this->input->post('asiento_y') : $asientos['asiento_y']); ?>" class="form-control" id="asiento_y" />
            ...
            <div class="form-group">
              <select name="vehiculo_id" class="form-control">
                ...
                <?php  
                          ...
                          { 
                              $selected = ($vehiculo['vehiculo_id'] == $asientos['vehiculo_id']) ? ' selected="selected"' : "";
