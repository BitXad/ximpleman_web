    ...
    <div style="float: right; text-align: center;">
        ...
        if($a == 3){
            if(is_null($servicio['servicio_codseguimiento'])){ ?>
                <a href="<?php echo $dir_url  ?>" id="finalizar" class="btn btn-sq-lg btn-success" style="width: 120px !important; height: 120px !important;" target="_blank" onclick="finalizarservicio2()" ><span class="fa fa-sign-out fa-4x"></span><br>Finalizar</a>
            <?php
            }else{ ?>
                <a href="<?php echo $dir_url  ?>" id="finalizar" class="btn btn-sq-lg btn-success" style="width: 120px !important; height: 120px !important;" target="_blank" ><span class="fa fa-sign-out fa-4x"></span><br>Finalizar</a>
            <?php
            }
        }else{?>
