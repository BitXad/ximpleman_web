            ...
            <table class="table table-striped table-condensed"  style="width: <?php echo $ancho; ?>;" >
                ...
                <?php
                    ...
                    //foreach($detalle_serv as $d){;
                        $cont = $cont+1;
                        $total += $detalle_serv['detalleserv_total']; 
                        $acuenta += $detalle_serv['detalleserv_acuenta']; 
                        $saldo += $detalle_serv['detalleserv_saldo']; 
                ?>
                <tr>
                    <td align="center" style="padding: 0;"><?php echo $detalle_serv['detalleserv_codigo']; ?></td>
                    <td style="padding: 0;"><font style="size:5px; font-family: arial narrow;"> <?php echo $detalle_serv['detalleserv_descripcion'];?></td>
                    <td align="right" style="padding: 0;"><?php echo number_format($detalle_serv['detalleserv_total'],2,'.',','); ?></td>
                    <td align="right" style="padding: 0;"><?php echo number_format($detalle_serv['detalleserv_acuenta'],2,'.',','); ?></td>
                    <td align="right" style="padding: 0;"><?php echo number_format($detalle_serv['detalleserv_saldo'],2,'.',','); ?></td>
                </tr>
                <?php //} ?>
                ...
                <tr>
                    <td colspan="5" style="padding:0;">
                        ...
                        TRANS.: <b><?php echo $detalle_serv['tipotrans_nombre']; ?></b><br>
                        <?php
                        if($detalle_serv['tipotrans_id'] == 2){
                        ?>
                        CUOTA INIC.: <?php echo $parametro[0]["moneda_descripcion"].": "; ?> <b><?php echo number_format($detalle_serv['credito_cuotainicial'],2,'.',','); ?></b><br>
                        SALDO: <?php echo $parametro[0]["moneda_descripcion"].": "; ?> <b><?php echo number_format($detalle_serv['credito_monto'],2,'.',','); ?></b><br>
                        <?php
                        }
                        ?>
                        <center>
