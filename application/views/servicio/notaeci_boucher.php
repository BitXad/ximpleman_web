...
<table class="table" >
    <tr>
        ...
        ?>
                            <img src="<?php echo base_url('resources/images/empresas/').$empresa[0]['empresa_imagen']; ?>" style="width: <?php echo ($parametro[0]["parametro_anchofactura"]-1)."cm" ?>; padding-bottom: 3px" height="100"><br>
