            ...
            <td style="padding: 0;">
                <table class="table" style="width: <?php echo $ancho;?>cm; padding: 0;" >
                    <tr>
                        ...
                        <td class="text-center" style="width: 6cm; padding: 0; line-height: 12px; " > 
                            <br>
                ...
                <table class="table table-striped table-condensed"  style="width: <?php echo $ancho;?>cm;" >
                   ...
                   <tr>
                        ...
                        <td style="padding: 0"><font style="font-size:10px; font-family: arial;"><?php echo $detalle_serv['detalleserv_descripcion'];?></td>
                        <td align="right" style="padding: 0">
                            <?php echo number_format($detalle_serv['detalleserv_total'],2,'.',','); ?>
                        </td>
                        <td align="right" style="padding: 0">
                            <?php echo number_format($detalle_serv['detalleserv_acuenta'],2,'.',','); ?>
                        </td>
                        <td align="right" style="padding: 0">
                            <?php echo number_format($detalle_serv['detalleserv_saldo'],2,'.',','); ?>
                        </td>
                    </tr>
                   <?php //} ?>
                </table>
