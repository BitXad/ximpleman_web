          		...
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="fecha_inicio_gestion" value="<?php echo $this->input->post('fecha_inicio_gestion'); ?>" class="has-datepicker form-control" id="fecha_inicio_gestion" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="lugar" value="<?php echo $this->input->post('lugar'); ?>" class="form-control" id="lugar" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="actividad" value="<?php echo $this->input->post('actividad'); ?>" class="form-control" id="actividad" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="ci_resp" class="control-label">Ci Resp</label>
						<div class="form-group">
							<input type="text" name="ci_resp" value="<?php echo $this->input->post('ci_resp'); ?>" class="form-control" id="ci_resp" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="responsable" class="control-label">Responsable</label>
						<div class="form-group">
							<input type="text" name="responsable" value="<?php echo $this->input->post('responsable'); ?>" class="form-control" id="responsable" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="fecha_fin" class="control-label">Fecha Fin</label>
						<div class="form-group">
							<input type="text" name="fecha_fin" value="<?php echo $this->input->post('fecha_fin'); ?>" class="has-datepicker form-control" id="fecha_fin" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="logotipo" class="control-label">Logotipo</label>
						<div class="form-group">
							<input type="text" name="logotipo" value="<?php echo $this->input->post('logotipo'); ?>" class="form-control" id="logotipo" />
						</div>
					</div>
				</div>
			</div>
