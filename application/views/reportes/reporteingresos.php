...
<div class="box-header no-print">
    <div class="text-center">
        <h3 class="box-title"><b>REPORTE GENERAL DE INGRESOS</b></h3><br><br>
    </div>
<div class="container">  
        <div class="box-tools" style="font-family: Arial;">
                <div class=" col-md-11">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            Fecha: <input type="date" value="<?php echo date('Y-m-d')?>" class="btn btn-primary btn-sm form-control" id="fecha_desde" name="fecha_desde" required="true">
                        </div>
                    
                        <div class="col-md-2">
                            Hora:<input type="time" value="<?php echo date('H:m')?>" class="btn btn-primary btn-sm form-control" id="hora_desde" name="hora_desde" required="true">
                        </div>
                    
                    
                    
                        <div class="col-md-2">
                            Fecha: <input type="date" value="<?php echo date('Y-m-d')?>" class="btn btn-primary btn-sm form-control datepicker" id="fecha_hasta" name="fecha_hasta" required="true">
                        </div>
                    
                        <div class="col-md-2">
                            Hora: <input type="time" value="<?php echo date('H:m')?>" class="btn btn-primary btn-sm form-control datepicker" id="hora_hasta" name="hora_hasta" required="true">
                        </div>
                    
                        <div class="col-md-2">
                            <br>
                            <button class="btn btn-sm btn-warning btn-sm btn-block"  type="submit" onclick="buscar_por_fechahora()" style="height: 34px;" id="boton_buscar">
...
<div class="row micontenedorep table-responsive" id="cabeceraprint">
    ...
    <tr>
        <td width="400" style="line-height: 14px; ">
            <center>
                <font size="3" face="arial"><b>REPORTE DE INGRESOS</b></font> <br>
