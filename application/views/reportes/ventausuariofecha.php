...
<script src="<?php echo base_url('resources/js/reporte_vusuariof.js'); ?>"></script>
...
<div class="cuerpo">
    ...
    <div class="columna_central">
        <center>
            <h3 class="box-title"><u>VENTAS POR FECHAS</u></h3>
...
<div class="row no-print" >
    ...
    <div class="col-md-1">
        <label>&nbsp;</label>
        <a class="btn btn-facebook btn-sm form-control" title="Buscar ventas por usuario" onclick="tablaresultados()"><i class="fa fa-search"> Buscar</i></a>
    </div>
    <div class="col-md-1">
...
<div class="box" style="padding: 0;">
    <div class="box-body table-responsive" >
        <table class="table table-striped table-condensed" id="mitabla" >
            <tbody class="buscar" id="losusuarios"></tbody>
            <!--<tr>-->
                <!--<th></th>-->
                <?php
                /*foreach ($all_usuario as $usuario) {
                    echo "<th>".$usuario['usuario_nombre']."</th>";
                }*/
                /*
                ?>
                <th>USUARIO</th>
