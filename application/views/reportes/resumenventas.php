    ...
    <div class="panel panel-primary col-md-12 no-print" id='buscador_oculto' >
        ...
        <div class="col-md-2 no-print">
           ...
           <div class="form-group">
                <a class="btn btn-facebook btn-sm form-control" onclick="tabla_reportesproducto_resumido()" title="Buscar productos agrupados"><i class="fa fa-search"> </i> Buscar</a>
            </div>
        </div>
        <div class="col-md-2 no-print">
            <label for="expotar" class="control-label"> &nbsp; </label>
...
<div class="box" style="padding: 0;">
    <div class="box-body table-responsive" >
        <table class="table table-striped table-condensed" style="max-width: 75cm;" id="mitabla" >
            <tr>
                <th>CANT</th>
                <th>PRODUCTO</th>
<!--                <th>TIPO<br>VENTA</th>
