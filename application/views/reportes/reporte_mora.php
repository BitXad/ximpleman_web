<script src="<?php echo base_url('resources/js/reporte_mora.js'); ?>" type="text/javascript"></script>
<!--
...
<div class="box-header no-print">
    <div class="text-center">
        <h3 class="box-title"><b>LISTA DE PRESTAMOS EN MORA</b></h3><br><br>
    </div>
<div class="container">  
        <div class="box-tools" style="font-family: Arial;">
                <div class=" col-md-11">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <br>
                            <button class="btn btn-sm btn-warning btn-sm btn-block"  type="submit" onclick="tabla_moras()" style="height: 34px;">
        ...
        <div class="table table-responsive">
            <table class='table table-striped table-condensed table-responsive' id='mitabladetimpresion' style='width:<?php echo $ancho; ?>cm;'>
                <tr style='background-color: #aaaaaa;' class='fondoprint'>
                    ...
                    <th id='fondoprint' style='width: 8%' class='text-center'>MORA</th>
                    <th id='fondoprint' style='width: 8%' class='text-center'>TOTAL <br> DEUDA</th>
                </tr>
