      	...
      	<div class="box box-info">
			...
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						<label for="rol_idfk" class="control-label">Rol</label>
						<div class="form-group">
							<select name="rol_idfk" class="form-control">
								...
								{
									$selected = ($rol['rol_id'] == $rol['rol_idfk']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="rol_descripcion"  class="form-control" id="rol_descripcion" required />
						</div>
					</div>
					</div>
				</div>
