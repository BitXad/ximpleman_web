...
<div class="box-header">
    ...
    <div class="box-tools no-print">
        <a href="<?php echo site_url('tipo_servicio/add'); ?>" class="btn btn-success btn-sm"><fa class='fa fa-pencil-square-o'></fa> Registrar Tipo Servicio</a>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
