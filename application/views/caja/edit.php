			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="caja_corte5" value="<?php echo ($this->input->post('caja_corte5') ? $this->input->post('caja_corte5') : $caja['caja_corte5']); ?>" class="form-control" id="caja_corte5" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_corte2" class="control-label">Caja Corte2</label>
						<div class="form-group">
							<input type="text" name="caja_corte2" value="<?php echo ($this->input->post('caja_corte2') ? $this->input->post('caja_corte2') : $caja['caja_corte2']); ?>" class="form-control" id="caja_corte2" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_corte1" class="control-label">Caja Corte1</label>
						<div class="form-group">
							<input type="text" name="caja_corte1" value="<?php echo ($this->input->post('caja_corte1') ? $this->input->post('caja_corte1') : $caja['caja_corte1']); ?>" class="form-control" id="caja_corte1" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_corte050" class="control-label">Caja Corte050</label>
						<div class="form-group">
							<input type="text" name="caja_corte050" value="<?php echo ($this->input->post('caja_corte050') ? $this->input->post('caja_corte050') : $caja['caja_corte050']); ?>" class="form-control" id="caja_corte050" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_corte020" class="control-label">Caja Corte020</label>
						<div class="form-group">
							<input type="text" name="caja_corte020" value="<?php echo ($this->input->post('caja_corte020') ? $this->input->post('caja_corte020') : $caja['caja_corte020']); ?>" class="form-control" id="caja_corte020" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_corte010" class="control-label">Caja Corte010</label>
						<div class="form-group">
							<input type="text" name="caja_corte010" value="<?php echo ($this->input->post('caja_corte010') ? $this->input->post('caja_corte010') : $caja['caja_corte010']); ?>" class="form-control" id="caja_corte010" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_corte005" class="control-label">Caja Corte005</label>
						<div class="form-group">
							<input type="text" name="caja_corte005" value="<?php echo ($this->input->post('caja_corte005') ? $this->input->post('caja_corte005') : $caja['caja_corte005']); ?>" class="form-control" id="caja_corte005" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_efectivo" class="control-label">Caja Efectivo</label>
						<div class="form-group">
							<input type="text" name="caja_efectivo" value="<?php echo ($this->input->post('caja_efectivo') ? $this->input->post('caja_efectivo') : $caja['caja_efectivo']); ?>" class="form-control" id="caja_efectivo" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_credito" class="control-label">Caja Credito</label>
						<div class="form-group">
							<input type="text" name="caja_credito" value="<?php echo ($this->input->post('caja_credito') ? $this->input->post('caja_credito') : $caja['caja_credito']); ?>" class="form-control" id="caja_credito" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_transacciones" class="control-label">Caja Transacciones</label>
						<div class="form-group">
							<input type="text" name="caja_transacciones" value="<?php echo ($this->input->post('caja_transacciones') ? $this->input->post('caja_transacciones') : $caja['caja_transacciones']); ?>" class="form-control" id="caja_transacciones" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="caja_corte1000" value="<?php echo ($this->input->post('caja_corte1000') ? $this->input->post('caja_corte1000') : $caja['caja_corte1000']); ?>" class="form-control" id="caja_corte1000" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_corte500" class="control-label">Caja Corte500</label>
						<div class="form-group">
							<input type="text" name="caja_corte500" value="<?php echo ($this->input->post('caja_corte500') ? $this->input->post('caja_corte500') : $caja['caja_corte500']); ?>" class="form-control" id="caja_corte500" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_corte200" class="control-label">Caja Corte200</label>
						<div class="form-group">
							<input type="text" name="caja_corte200" value="<?php echo ($this->input->post('caja_corte200') ? $this->input->post('caja_corte200') : $caja['caja_corte200']); ?>" class="form-control" id="caja_corte200" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_corte100" class="control-label">Caja Corte100</label>
						<div class="form-group">
							<input type="text" name="caja_corte100" value="<?php echo ($this->input->post('caja_corte100') ? $this->input->post('caja_corte100') : $caja['caja_corte100']); ?>" class="form-control" id="caja_corte100" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_corte50" class="control-label">Caja Corte50</label>
						<div class="form-group">
							<input type="text" name="caja_corte50" value="<?php echo ($this->input->post('caja_corte50') ? $this->input->post('caja_corte50') : $caja['caja_corte50']); ?>" class="form-control" id="caja_corte50" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_corte20" class="control-label">Caja Corte20</label>
						<div class="form-group">
							<input type="text" name="caja_corte20" value="<?php echo ($this->input->post('caja_corte20') ? $this->input->post('caja_corte20') : $caja['caja_corte20']); ?>" class="form-control" id="caja_corte20" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="caja_corte10" class="control-label">Caja Corte10</label>
						<div class="form-group">
							<input type="text" name="caja_corte10" value="<?php echo ($this->input->post('caja_corte10') ? $this->input->post('caja_corte10') : $caja['caja_corte10']); ?>" class="form-control" id="caja_corte10" />
						</div>
					</div>
				</div>
			</div>
