                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px" name="caja_corte200" value="<?php echo ($this->input->post('caja_corte200') ? $this->input->post('caja_corte200') : 0); ?>" class="form-control" id="caja_corte200"  onkeyup="calcular_caja()"/>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px" name="caja_corte100" value="<?php echo ($this->input->post('caja_corte100') ? $this->input->post('caja_corte100') : 0); ?>" class="form-control" id="caja_corte100"  onkeyup="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px" name="caja_corte50" value="<?php echo ($this->input->post('caja_corte50') ? $this->input->post('caja_corte50') : 0); ?>" class="form-control" id="caja_corte50"  onkeyup="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px" name="caja_corte20" value="<?php echo ($this->input->post('caja_corte20') ? $this->input->post('caja_corte20') : 0); ?>" class="form-control" id="caja_corte20"  onkeyup="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px" name="caja_corte10" value="<?php echo ($this->input->post('caja_corte10') ? $this->input->post('caja_corte10') : 0); ?>" class="form-control" id="caja_corte10"  onkeyup="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px" name="caja_corte5" value="<?php echo ($this->input->post('caja_corte5') ? $this->input->post('caja_corte5') : 0); ?>" class="form-control" id="caja_corte5"  onkeyup="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px" name="caja_corte2" value="<?php echo ($this->input->post('caja_corte2') ? $this->input->post('caja_corte2') : 0); ?>" class="form-control" id="caja_corte2"  onkeyup="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px" name="caja_corte1" value="<?php echo ($this->input->post('caja_corte1') ? $this->input->post('caja_corte1') : 0); ?>" class="form-control" id="caja_corte1"  onkeyup="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px" name="caja_corte050" value="<?php echo ($this->input->post('caja_corte050') ? $this->input->post('caja_corte050') : 0); ?>" class="form-control" id="caja_corte050"  onkeyup="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px" name="caja_corte020" value="<?php echo ($this->input->post('caja_corte020') ? $this->input->post('caja_corte020') : 0); ?>" class="form-control" id="caja_corte020"  onkeyup="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px" name="caja_corte010" value="<?php echo ($this->input->post('caja_corte010') ? $this->input->post('caja_corte010') : 0); ?>" class="form-control" id="caja_corte010"  onkeyup="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px" name="caja_corte005" value="<?php echo ($this->input->post('caja_corte005') ? $this->input->post('caja_corte005') : 0); ?>" class="form-control" id="caja_corte005"  onkeyup="calcular_caja()"/>
                            </div>
