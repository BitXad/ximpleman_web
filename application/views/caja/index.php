...
<!-- Script buscador por texto y por fecha -->
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#fecha_cierre').on('change', function () {
            var fecha = $(this).val(); // formato yyyy-mm-dd
            $('#mitabla tbody tr').each(function () {
                var textoFecha = $(this).find('td').eq(10).text(); // columna 11 es FECHA CIERRE
                if (textoFecha.includes(fecha)) {
                    $(this).show();
                } else {
                    $(this).hide();
                }
...
<div class="box-header">
    <font size='4' face='Arial'><b>Caja</b></font><br>
    <font size='2' face='Arial'>Registros Encontrados: <?php echo sizeof($caja); ?></font>
...
<div class="row">
    ...
    <div class="col-md-3">
        <input id="fecha_cierre" type="date" class="form-control">
    </div>
</div>
<br>
                ...
                <table class="table table-striped table-condensed" id="mitabla">
                    ...
                    <tbody class="buscar">
                        ...
                        <tr>
                            ...
                            <td><?php echo $c['caja_fechaapertura']." ".$c['caja_horaapertura']; ?></td>
                            ...
                            <td style="text-align: right; background:#00FF00; font-weight: bold;"><?php echo number_format($c['caja_transacciones'] + $c['caja_apertura'],2,'.',','); ?></td>
                            <td style="text-align: right; background:#00FF00; font-weight: bold;"><?php echo number_format(is_numeric($c['caja_cierre'])?$c['caja_cierre']:0,2,'.',','); ?></td>
                            <td style="text-align: right; background:#ff0; font-weight: bold;"><?php echo number_format(is_numeric($c['caja_diferencia'])?$c['caja_diferencia']:0,2,'.',','); ?></td>
