                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" name="caja_corte200" style="height: 61px; font-size: 15pt;" value="<?php echo ($this->input->post('caja_corte200') ? $this->input->post('caja_corte200') : 0); ?>" class="form-control" id="caja_corte200"  onchange="calcular_caja()"/>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px; font-size: 15pt;" name="caja_corte100" value="<?php echo ($this->input->post('caja_corte100') ? $this->input->post('caja_corte100') : 0); ?>" class="form-control" id="caja_corte100"  onchange="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0"  style="height: 61px; font-size: 15pt;"  name="caja_corte50" value="<?php echo ($this->input->post('caja_corte50') ? $this->input->post('caja_corte50') : 0); ?>" class="form-control" id="caja_corte50"  onchange="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px; font-size: 15pt;" name="caja_corte20" value="<?php echo ($this->input->post('caja_corte20') ? $this->input->post('caja_corte20') : 0); ?>" class="form-control" id="caja_corte20"  onchange="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px; font-size: 15pt;" name="caja_corte10" value="<?php echo ($this->input->post('caja_corte10') ? $this->input->post('caja_corte10') : 0); ?>" class="form-control" id="caja_corte10"  onchange="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px; font-size: 15pt;" name="caja_corte5" value="<?php echo ($this->input->post('caja_corte5') ? $this->input->post('caja_corte5') : 0); ?>" class="form-control" id="caja_corte5"  onchange="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px; font-size: 15pt;" name="caja_corte2" value="<?php echo ($this->input->post('caja_corte2') ? $this->input->post('caja_corte2') : 0); ?>" class="form-control" id="caja_corte2"  onchange="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px; font-size: 15pt;" name="caja_corte1" value="<?php echo ($this->input->post('caja_corte1') ? $this->input->post('caja_corte1') : 0); ?>" class="form-control" id="caja_corte1"  onchange="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px; font-size: 15pt;" name="caja_corte050" value="<?php echo ($this->input->post('caja_corte050') ? $this->input->post('caja_corte050') : 0); ?>" class="form-control" id="caja_corte050"  onchange="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px; font-size: 15pt;" name="caja_corte020" value="<?php echo ($this->input->post('caja_corte020') ? $this->input->post('caja_corte020') : 0); ?>" class="form-control" id="caja_corte020"  onchange="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px; font-size: 15pt;" name="caja_corte010" value="<?php echo ($this->input->post('caja_corte010') ? $this->input->post('caja_corte010') : 0); ?>" class="form-control" id="caja_corte010"  onchange="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="number" step="any" min="0" style="height: 61px; font-size: 15pt;" name="caja_corte005" value="<?php echo ($this->input->post('caja_corte005') ? $this->input->post('caja_corte005') : 0); ?>" class="form-control" id="caja_corte005"  onchange="calcular_caja()"/>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <input type="number" style="height: 61px; font-size: 15pt;" step="any" min="0" name="caja_cierre" value="<?php echo ($this->input->post('caja_cierre') ? $this->input->post('caja_cierre') : $caja['caja_cierre']); ?>" class="form-control" id="caja_cierre" autofocus required readonly/>
                                <button class="btn btn-warning btn-xs btn-block" type="button" onclick="verificar_caja()"><fa class="fa fa-spinner"> </fa> Verificar</button>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" style="height: 61px; font-size: 15pt; background: #000; color: red;" step="any" min="0" name="caja_estado" value="<?php echo ($this->input->post('caja_estado') ? $this->input->post('caja_cierre') : $caja['caja_cierre']); ?>" class="form-control" id="caja_estado" readonly="true" autofocus required />
...
<!--                        <div class="col-md-3">
          	...
          	<div class="box-footer" id="div_guardar" style="display:none;">
