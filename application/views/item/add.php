    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Añadir Item</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="submenu_id" class="form-control">
								...
								{
									$selected = ($submenu['submenu_id'] == $this->input->post('submenu_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="item_nombre" value="<?php echo $this->input->post('item_nombre'); ?>" class="form-control" id="item_nombre" required />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="item_descripcion" value="<?php echo $this->input->post('item_descripcion'); ?>" class="form-control" id="item_descripcion" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="item_enlace" class="control-label">Enlace</label>
						<div class="form-group">
							<input type="text" name="item_enlace" value="<?php echo $this->input->post('item_enlace'); ?>" class="form-control" id="item_enlace" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="item_imagen" class="control-label">Imagen</label>
						<div class="form-group">
							<input type="text" name="item_imagen" value="<?php echo $this->input->post('item_imagen'); ?>" class="form-control" id="item_imagen" />
						</div>
					</div>
				</div>
			</div>
