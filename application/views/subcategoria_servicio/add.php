                    ...
                    <div class="row clearfix">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="subcatserv_descripcion" value="<?php echo $this->input->post('subcatserv_descripcion'); ?>" class="form-control" id="subcatserv_descripcion" required onKeyUp="this.value = this.value.toUpperCase();" />
