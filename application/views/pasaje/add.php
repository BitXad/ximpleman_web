<div class="row">
    <div class="col-md-12">
            <?php echo form_open('pasaje/add'); ?>
             <div class="col-md-6">
               <label for="pasaje_id" class="control-label"> <span class="text-danger"></span>ID</label>
                <div class="form-group">
                  <input type="number" name="pasaje_id" value="<?php echo $this->input->post('pasaje_id'); ?>" class="form-control " id="pasaje_id" />
                  ...
                  <select name="asiento_id" class="form-control"> 
                    <option value="">select asiento_id</option>
                     <?php
                          ...
                          {
                              $selected = ($asientos['asiento_id'] == $this->input->post('asiento_id')) ? ' selected="selected"' : ""; 
                  ...
                  <select name="viaje_id" class="form-control"> 
                    <option value="">select viaje_id</option>
                     <?php
                          ...
                          {
                              $selected = ($tipo_vehiculo['tipomovilidad_id'] == $this->input->post('viaje_id')) ? ' selected="selected"' : ""; 
            ...
            <div class="col-md-6">
             ...
             <div class="col-md-6">
               <label for="pasaje_numero" class="control-label"> <span class="text-danger"></span>NUMERO</label>
                <div class="form-group">
                  <input type="text" name="pasaje_numero" value="<?php echo $this->input->post('pasaje_numero'); ?>" class="form-control " id="pasaje_numero" />
             ...
             <div class="col-md-6">
               <label for="pasaje_precio" class="control-label"> <span class="text-danger"></span>PRECIO</label>
                <div class="form-group">
                  <input type="text" name="pasaje_precio" value="<?php echo $this->input->post('pasaje_precio'); ?>" class="form-control " id="pasaje_precio" />
             ...
             <div class="col-md-6">
               <label for="pasaje_nombre" class="control-label"> <span class="text-danger"></span>NOMBRE</label>
                <div class="form-group">
                  <input type="text" name="pasaje_nombre" value="<?php echo $this->input->post('pasaje_nombre'); ?>" class="form-control " id="pasaje_nombre" />
             ...
             <div class="col-md-6">
               <label for="pasaje_apellido" class="control-label"> <span class="text-danger"></span>APELLIDOS</label>
                <div class="form-group">
                  <input type="text" name="pasaje_apellido" value="<?php echo $this->input->post('pasaje_apellido'); ?>" class="form-control " id="pasaje_apellido" />
             ...
             <div class="col-md-6">
               <label for="pasaje_fecha" class="control-label"> <span class="text-danger"></span>FECHA</label>
                <div class="form-group">
                  <input type="text" name="pasaje_fecha" value="<?php echo $this->input->post('pasaje_fecha'); ?>" class="has-datepicker form-control" data-date-format='YYYY-MM-DD' id="pasaje_fecha" />
             ...
             <div class="col-md-6">
               <label for="pasaje_hora" class="control-label"> <span class="text-danger"></span>HORA</label>
                <div class="form-group">
                  <input type="text" name="pasaje_hora" value="<?php echo $this->input->post('pasaje_hora'); ?>" class="form-control " id="pasaje_hora" />
