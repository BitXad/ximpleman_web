    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Editar Botón Articulo</h3>
            </div>
			<?php echo form_open('boton_articulo/edit/'.$boton_articulo['botonartic_id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="articulo_id" class="form-control">
								...
								{
									$selected = ($articulo['articulo_id'] == $boton_articulo['articulo_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="boton_id" class="form-control">
								...
								{
									$selected = ($boton['boton_id'] == $boton_articulo['boton_id']) ? ' selected="selected"' : "";
