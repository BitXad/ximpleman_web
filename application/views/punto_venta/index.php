...
if (!$almacén_cert = file_get_contents($llave_privada_url)) {
    ...
    if (openssl_pkcs12_read($almacén_cert, $certificadox, "5152377")) {
    //echo "Información del certificado\n";
         //print_r($info_cert);
         //echo "<br><br>";
         $info_cert = openssl_x509_parse($certificadox);
...
//              MIIHNjCCBR6gAwIBAgIIIoXBsnAmisUwDQYJKoZIhvcNAQELBQAwSzEsMCoGA1UEAwwjRW50aWRh
