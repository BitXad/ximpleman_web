          		...
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="catserv_descripcion" value="<?php echo $this->input->post('catserv_descripcion'); ?>" onKeyUp="this.value = this.value.toUpperCase();" class="form-control" id="catserv_descripcion" required />
