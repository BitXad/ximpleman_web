          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="boton_titulo" value="<?php echo $this->input->post('boton_titulo'); ?>" class="form-control" id="boton_titulo" required />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="boton_descripcion" value="<?php echo $this->input->post('boton_descripcion'); ?>" class="form-control" id="boton_descripcion" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="boton_enlace" class="control-label">Enlace</label>
						<div class="form-group">
							<input type="text" name="boton_enlace" value="<?php echo $this->input->post('boton_enlace'); ?>" class="form-control" id="boton_enlace" />
						</div>
					</div>
				</div>
			</div>
