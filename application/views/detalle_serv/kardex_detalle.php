...
<div class="row">
   ...
   <!-- ---------------------- Inicio modal para registrar Nuevo Detalle de Servicio con información ----------------- -->
    <div class="modal fade" id="modaldetalle<?php echo $i; ?>" tabindex="-1" role="dialog" aria-labelledby="modaldetalleLabel">
      <div class="modal-dialog" role="document">
            <br><br>
        <div class="modal-content">
          <div class="modal-header">
              <label>Producto("<?php echo $d['detalleserv_codigo']; ?>") a Registrar al Servicio N° <?php echo $servicio['servicio_id'] ?></label>
          ...
          <div class="modal-body">
           <!------------------------------------------------------------------->
					...
					<div class="col-md-6">
						...
						<div class="form-group">
                                                    <input type="text" name="detalleserv_descripcion" value="<?php echo $d['detalleserv_descripcion']; ?>" class="form-control" id="detalleserv_descripcion" required />
						</div>
					</div>
					<div class="col-md-6">
						<label for="detalleserv_falla" class="control-label"><span class="text-danger">*</span>Problema/Falla Segun Cliente</label>
						<div class="form-group">
                                                    <input type="text" name="detalleserv_falla" value="<?php echo $d['detalleserv_falla']; ?>" class="form-control" id="detalleserv_falla" required />
						</div>
					</div>
					<div class="col-md-6">
						<label for="detalleserv_diagnostico" class="control-label">Diagnostico</label>
						<div class="form-group">
							<input type="text" name="detalleserv_diagnostico" value="<?php if($d['detalleserv_diagnostico'] == null){ echo 'REVISION'; }else{ echo $d['detalleserv_diagnostico'];} ?>" class="form-control" id="detalleserv_diagnostico" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="detalleserv_solucion" class="control-label">Solución</label>
						<div class="form-group">
							<input type="text" name="detalleserv_solucion" value="<?php if($d['detalleserv_solucion'] == null){ echo 'REVISION'; }else{ echo $d['detalleserv_solucion'];} ?>" class="form-control" id="detalleserv_solucion" />
						</div>
					</div>
                                        <div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input style="background-color: #ffeebc;" type="number" step="any" min="0" name="detalleserv_total" value="<?php echo number_format($d['detalleserv_total'],'2','.',','); ?>" class="form-control" id="detalleserv_total" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="detalleserv_acuenta" class="control-label">A cuenta</label>
						<div class="form-group">
							<input style="background-color: #ffeebc;" type="number" step="any" min="0" name="detalleserv_acuenta" value="<?php echo number_format($d['detalleserv_acuenta'],'2','.',','); ?>" class="form-control" id="detalleserv_acuenta" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="detalleserv_saldo" class="control-label">Saldo</label>
						<div class="form-group">
                                                    <input style="background-color: #ffeebc;" type="number" step="any" min="0" name="detalleserv_saldo" value="<?php echo number_format($d['detalleserv_saldo'],'2','.',','); ?>" class="form-control" id="detalleserv_saldo" readonly />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
								...
								{
									$selected = ($responsable['responsable_id'] == $d['responsable_id']) ? ' selected="selected"' : "";
...
<!-- ---------------------- Fin modal para registrar Nuevo Detalle de Servicio con información ----------------- -->
                                                ...
                                                <td id="horizontal"> <?php 
                                                          ...
                                                          echo '<font size="1"><b>Tec.: </b>'.$d['responsable_nombres']." ".$d['responsable_apellidos'].'</font><br>';
