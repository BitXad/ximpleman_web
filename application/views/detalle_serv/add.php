    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Detalle Serv Add</h3>
            </div>
            <?php echo form_open('detalle_serv/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="responsable_id" value="<?php echo $this->input->post('responsable_id'); ?>" class="form-control" id="responsable_id" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="detalleserv_descripcion" class="control-label">Detalleserv Descripcion</label>
						<div class="form-group">
							<input type="text" name="detalleserv_descripcion" value="<?php echo $this->input->post('detalleserv_descripcion'); ?>" class="form-control" id="detalleserv_descripcion" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="detalleserv_codigo" class="control-label">Detalleserv Codigo</label>
						<div class="form-group">
							<input type="text" name="detalleserv_codigo" value="<?php echo $this->input->post('detalleserv_codigo'); ?>" class="form-control" id="detalleserv_codigo" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="detalleserv_falla" class="control-label">Detalleserv Falla</label>
						<div class="form-group">
							<input type="text" name="detalleserv_falla" value="<?php echo $this->input->post('detalleserv_falla'); ?>" class="form-control" id="detalleserv_falla" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="detalleserv_total" value="<?php echo $this->input->post('detalleserv_total'); ?>" class="form-control" id="detalleserv_total" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="detalleserv_acuenta" class="control-label">Detalleserv Acuenta</label>
						<div class="form-group">
							<input type="text" name="detalleserv_acuenta" value="<?php echo $this->input->post('detalleserv_acuenta'); ?>" class="form-control" id="detalleserv_acuenta" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="detalleserv_saldo" class="control-label">Detalleserv Saldo</label>
						<div class="form-group">
							<input type="text" name="detalleserv_saldo" value="<?php echo $this->input->post('detalleserv_saldo'); ?>" class="form-control" id="detalleserv_saldo" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="detalleserv_fechaterminado" class="control-label">Detalleserv Fechaterminado</label>
						<div class="form-group">
							<input type="text" name="detalleserv_fechaterminado" value="<?php echo $this->input->post('detalleserv_fechaterminado'); ?>" class="has-datepicker form-control" id="detalleserv_fechaterminado" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="detalleserv_horaterminado" class="control-label">Detalleserv Horaterminado</label>
						<div class="form-group">
							<input type="text" name="detalleserv_horaterminado" value="<?php echo $this->input->post('detalleserv_horaterminado'); ?>" class="form-control" id="detalleserv_horaterminado" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="detalleserv_horaentrega" value="<?php echo $this->input->post('detalleserv_horaentrega'); ?>" class="form-control" id="detalleserv_horaentrega" />
						</div>
					</div>
					<div class="col-md-6">
