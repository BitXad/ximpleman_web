...
<div class="box-header">
    <font size='4' face='Arial'><b>C&oacute;digos de Eventos Significativos</b></font>
                ...
                <table class="table table-striped table-condensed" id="mitabla">
                    ...
                    <tbody class="buscar">
                        ...
                        foreach ($datos as $sincronizacion) {?>
                            <tr>
                                <td><?= $i ?></td>
                                <td><?= $sincronizacion['ces_codigoclasificador'] ?></td>
                                <td><?= $sincronizacion['ces_descripcion'] ?></td>
                            </tr>
                        <?php
                            $i++; 
                        }
