...
<div class="box-header">
    <font size='4' face='Arial'><b>C&oacute;digos de Tipo Habitación</b></font>
                ...
                <table class="table table-striped table-condensed" id="mitabla">
                    ...
                    <tbody class="buscar">
                        ...
                        foreach ($datos as $sincronizacion) {?>
                            <tr>
                                <td><?= $i ?></td>
                                <td><?= $sincronizacion['tipohab_codigoclasificador'] ?></td>
                                <td><?= $sincronizacion['tipohab_descripcion'] ?></td>
                            </tr>
                        <?php
                            $i++; 
                        }
