    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Añadir Articulo</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="seccion_id" class="form-control">
								...
								{
									$selected = ($seccion['seccion_id'] == $this->input->post('seccion_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
                                                    <input type="text" name="articulo_titulo" value="<?php echo $this->input->post('articulo_titulo'); ?>" class="form-control" id="articulo_titulo" required />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="articulo_descripcion" value="<?php echo $this->input->post('articulo_descripcion'); ?>" class="form-control" id="articulo_descripcion" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="articulo_texto" class="control-label">Texto</label>
						<div class="form-group">
							<input type="text" name="articulo_texto" value="<?php echo $this->input->post('articulo_texto'); ?>" class="form-control" id="articulo_texto" />
						</div>
					</div>
				</div>
			</div>
