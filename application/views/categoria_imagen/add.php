    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Añadir Categoria Imagen</h3>
            </div>
            <?php echo form_open('categoria_imagen/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="galeria_id" class="form-control">
								...
								{
									$selected = ($galeria['galeria_id'] == $this->input->post('galeria_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="catimg_nombre" value="<?php echo $this->input->post('catimg_nombre'); ?>" class="form-control" id="catimg_nombre" required />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="catimg_descripcion" value="<?php echo $this->input->post('catimg_descripcion'); ?>" class="form-control" id="catimg_descripcion" />
						</div>
					</div>
				</div>
			</div>
