...
<script src="<?php echo base_url('resources/js/clasificador_inventario.js'); ?>"></script>
    ...
    <tr>
        ...
        <td style="width: 6cm; padding: 0" > 
            <center>
                ...
                <br><br>
                <font size="3" face="arial"><b>INVENTARIO DE CLASIFICADORES</b></font> <br>
...
<div class="box-header no-print">
            ...
            <div class="box-tools no-print" style="position: inherit; text-align: center !important">
                ...
                <?php if(1 == 1){ ?>
                <button class="btn btn-primary btn-sm" onclick="tabla_clasificadorinventario()" type="button"><span class="fa fa-list"></span> Mostrar todo</button>
