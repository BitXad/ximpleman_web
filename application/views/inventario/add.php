<?php echo form_open('inventario/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="compras" value="<?php echo $this->input->post('compras'); ?>" class="form-control" id="compras" />
		</div>
	</div>
	<div class="form-group">
		<label for="ventas" class="col-md-4 control-label">Ventas</label>
		<div class="col-md-8">
			<input type="text" name="ventas" value="<?php echo $this->input->post('ventas'); ?>" class="form-control" id="ventas" />
		</div>
	</div>
	<div class="form-group">
		<label for="pedidos" class="col-md-4 control-label">Pedidos</label>
		<div class="col-md-8">
			<input type="text" name="pedidos" value="<?php echo $this->input->post('pedidos'); ?>" class="form-control" id="pedidos" />
		</div>
	</div>
	<div class="form-group">
		<label for="existencia" class="col-md-4 control-label">Existencia</label>
		<div class="col-md-8">
			<input type="text" name="existencia" value="<?php echo $this->input->post('existencia'); ?>" class="form-control" id="existencia" />
		</div>
	</div>
