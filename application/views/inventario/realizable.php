    ...
    <tr>
        ...
        <td style="width: 6cm; padding: 0" > 
            <center>
                ...
                <br><br>
                <font size="3" face="arial"><b>INVENTARIO REALIZABLE</b></font> <br>
...
<div class="box-header no-print">
            ...
            <div class="box-tools no-print">
                ...
                <button class="btn btn-primary btn-sm" onclick="tabla_inventario_realizable()" type="button"><span class="fa fa-list"></span> Mostrar todo</button>

                <button class="btn btn-info btn-sm" onclick="tabla_existencia_realizable()" type="button"><span class="fa fa-list-ol" title="Ver Produtos con Existencia"></span> Con Existencia</button>
