...
<div class="box-header">
    <font size='4' face='Arial'><b>Tiempo de Uso</b></font>
    <br><font size='2' face='Arial'>Registros Encontrados: <?php echo sizeof($tiempo_uso); ?></font>
    <div class="box-tools no-print">
        <a href="<?php echo site_url('tiempo_uso/add'); ?>" class="btn btn-success btn-sm">
            <fa class='fa fa-pencil-square-o'></fa> Registrar Tiempo de Uso
        </a>
    </div>
</div>
                    ...
                    <tbody class="buscar">
                        ...
                        <tr>
                            ...
                            <td class="no-print">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer aligncenter">
                                                <a href="<?php echo site_url('tiempo_uso/remove/'.$t['tiempouso_id']); ?>" class="btn btn-success">
                                ...
                                <!-- Botón editar -->
                                <a href="<?php echo site_url('tiempo_uso/edit/'.$t['tiempouso_id']); ?>" class="btn btn-info btn-xs" title="Editar">
