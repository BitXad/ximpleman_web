...
<div class="box-header">
    ...
    <div class="box-tools no-print">
        <a href="<?php echo site_url('producto_preferencia/add'); ?>" class="btn btn-success btn-sm" target="_blank">
            <fa class='fa fa-pencil-square-o'></fa> Registrar producto-preferencia
        </a>
    </div>
</div>
        ...
        <div class="box">
            <div class="box-body table-responsive">
                <table class="table table-striped table-condensed" id="mitabla">
                    ...
                    <tbody class="buscar">
                        <?php $cont = 0; foreach($producto_preferencia as $p){ $cont++; ?>
                        <tr>
                            <td class="text-center"><?php echo $cont; ?></td>
                            <td><?php echo $p['producto_nombre']; ?></td>
                            <td><?php echo $p['preferencia_descripcion']; ?></td>
                            <td class="text-center no-print">
                                <a class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modalEliminar<?php echo $p['productopref_id']; ?>" title="Eliminar">
                                    <span class="fa fa-trash"></span>
                                </a>

                                <!------------------------ INICIO modal para confirmar eliminación ------------------->
                                <div class="modal fade" id="modalEliminar<?php echo $p['productopref_id']; ?>" tabindex="-1" role="dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h3><b><span class="fa fa-trash"></span></b>
                                                    ¿Desea eliminar producto-preferencia: <br>
                                                    <b><?php echo $p['producto_nombre'] . " - " . $p['preferencia_descripcion']; ?></b>?
                                                </h3>
                                            </div>
                                            <div class="modal-footer aligncenter">
                                                <a href="<?php echo site_url('producto_preferencia/remove/'.$p['productopref_id']); ?>" class="btn btn-success">
