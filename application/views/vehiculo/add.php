<div class="row">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <?php echo form_open_multipart('vehiculo/add', array('id' => 'form_vehiculo_add')); ?>
            <div class="box-body">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="vehiculo_nombrespropietario"
                                   value="<?php echo set_value('vehiculo_nombrespropietario'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="vehiculo_apellidospropietario"
                                   value="<?php echo set_value('vehiculo_apellidospropietario'); ?>"
                    ...
                    <input type="hidden" name="estado_id" value="<?php echo set_value('estado_id', '1'); ?>">

                    <div class="col-md-3">
                        <label for="tipomovilidad_id" class="control-label">Tipo movilidad</label>
                        <div class="form-group">
                            <input type="number" name="tipomovilidad_id"
                                   value="<?php echo set_value('tipomovilidad_id'); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="number" name="categoriavehiculo_id"
                                   value="<?php echo set_value('categoriavehiculo_id'); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="vehiculo_placa"
                                   value="<?php echo set_value('vehiculo_placa'); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="vehiculo_clase"
                                   value="<?php echo set_value('vehiculo_clase'); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="vehiculo_marca"
                                   value="<?php echo set_value('vehiculo_marca'); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="vehiculo_modelo"
                                   value="<?php echo set_value('vehiculo_modelo'); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="vehiculo_tipocombustible"
                                   value="<?php echo set_value('vehiculo_tipocombustible'); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="vehiculo_carroceria"
                                   value="<?php echo set_value('vehiculo_carroceria'); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="vehiculo_color"
                                   value="<?php echo set_value('vehiculo_color'); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="vehiculo_numeromotor"
                                   value="<?php echo set_value('vehiculo_numeromotor'); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="vehiculo_serie"
                                   value="<?php echo set_value('vehiculo_serie'); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="vehiculo_tiposervicio"
                                   value="<?php echo set_value('vehiculo_tiposervicio'); ?>"
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <input type="number" name="vehiculo_aniofabricacion"
                                   value="<?php echo set_value('vehiculo_aniofabricacion'); ?>"
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <input type="number" name="vehiculo_ejes"
                                   value="<?php echo set_value('vehiculo_ejes'); ?>"
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <input type="number" name="vehiculo_cilindros"
                                   value="<?php echo set_value('vehiculo_cilindros'); ?>"
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <input type="number" name="vehiculo_ruedas"
                                   value="<?php echo set_value('vehiculo_ruedas'); ?>"
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <input type="number" name="vehiculo_pasajeros"
                                   value="<?php echo set_value('vehiculo_pasajeros'); ?>"
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <input type="number" name="vehiculo_asientos"
                                   value="<?php echo set_value('vehiculo_asientos'); ?>"
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <input type="number" step="0.01" name="vehiculo_longitud"
                                   value="<?php echo set_value('vehiculo_longitud'); ?>"
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <input type="number" step="0.01" name="vehiculo_altura"
                                   value="<?php echo set_value('vehiculo_altura'); ?>"
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <input type="number" step="0.01" name="vehiculo_ancho"
                                   value="<?php echo set_value('vehiculo_ancho'); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="number" step="0.01" name="vehiculo_pesoseco"
                                   value="<?php echo set_value('vehiculo_pesoseco'); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="number" step="0.01" name="vehiculo_pesobruto"
                                   value="<?php echo set_value('vehiculo_pesobruto'); ?>"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <input type="text" name="vehiculo_ruat"
                                   value="<?php echo set_value('vehiculo_ruat'); ?>"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <input type="text" name="vehiculo_tarjetacirculacion"
                                   value="<?php echo set_value('vehiculo_tarjetacirculacion'); ?>"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <input type="date" name="vehiculo_fechatarjeta"
                                   value="<?php echo set_value('vehiculo_fechatarjeta'); ?>"
                        ...
                        <div class="form-group">
                            <div style="border:1px solid #ddd; padding:10px; min-height:220px; text-align:center;">
                                <img id="preview_imagen"
                                     src="<?php echo base_url('resources/images/system/no-image.png'); ?>"
                                     alt="Vista previa"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    inputFile.addEventListener('change', function (e) {
        ...
        if (!file) {
            preview.src = "<?php echo base_url('resources/images/system/no-image.png'); ?>";
            return;
        }
