			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="moneda_descripcion" value="<?php echo ($this->input->post('moneda_descripcion') ? $this->input->post('moneda_descripcion') : $moneda['moneda_descripcion']); ?>" class="form-control" id="moneda_descripcion" required />
