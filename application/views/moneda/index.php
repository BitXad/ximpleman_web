...
<input type="hidden" id="decimales" value="<?php echo $decimales; ?>">

<div class="box-header">
    <font size='4' face='Arial'><b>Moneda</b></font><br>
    <font size='2' face='Arial'>Registros Encontrados: <?php echo sizeof($moneda); ?></font>
    <div class="box-tools no-print">
        <a href="<?php echo site_url('moneda/add'); ?>" class="btn btn-success btn-sm">
            <fa class='fa fa-pencil-square-o'></fa> Registrar Moneda
        </a>
    </div>
</div>
...
<div class="box">
    <div class="box-body table-responsive">
        <table class="table table-striped table-condensed" id="mitabla">
            ...
            <tbody class="buscar">
                <?php $cont = 0; foreach($monedas as $m){ $cont++; ?>
                <tr>
                    <td><?php echo $cont; ?></td>
                    <td><?php echo $m['moneda_descripcion']; ?></td>
                    <td><?php echo number_format($m['moneda_tc'], $decimales, ".", ","); ?></td>
                    <td style="background-color: #<?php echo $m['estado_color']; ?>">
                        <?php echo $m['estado_descripcion']; ?>
                    </td>
                    <td class="no-print">
                        <a href="<?php echo site_url('moneda/edit/'.$m['moneda_id']); ?>" class="btn btn-info btn-xs">
