    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tabla Asiento Add</h3>
            </div>
            <?php echo form_open('tabla_asiento/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="cod_cuenta" class="form-control">
								...
								{
									$selected = ($cuenta['cod_cuenta'] == $this->input->post('cod_cuenta')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nombre_mayor" value="<?php echo $this->input->post('nombre_mayor'); ?>" class="form-control" id="nombre_mayor" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="debe_bs" value="<?php echo $this->input->post('debe_bs'); ?>" class="form-control" id="debe_bs" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="haber_bs" class="control-label">Haber Bs</label>
						<div class="form-group">
							<input type="text" name="haber_bs" value="<?php echo $this->input->post('haber_bs'); ?>" class="form-control" id="haber_bs" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="debe_sus" class="control-label">Debe Sus</label>
						<div class="form-group">
							<input type="text" name="debe_sus" value="<?php echo $this->input->post('debe_sus'); ?>" class="form-control" id="debe_sus" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="haber_sus" class="control-label">Haber Sus</label>
						<div class="form-group">
							<input type="text" name="haber_sus" value="<?php echo $this->input->post('haber_sus'); ?>" class="form-control" id="haber_sus" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="saldo_bs" class="control-label">Saldo Bs</label>
						<div class="form-group">
							<input type="text" name="saldo_bs" value="<?php echo $this->input->post('saldo_bs'); ?>" class="form-control" id="saldo_bs" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="saldo_sus" class="control-label">Saldo Sus</label>
						<div class="form-group">
							<input type="text" name="saldo_sus" value="<?php echo $this->input->post('saldo_sus'); ?>" class="form-control" id="saldo_sus" />
						</div>
					</div>
				</div>
			</div>
