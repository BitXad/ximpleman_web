...
<div class="row no-print">
    ...
    <div class="col-md-5">
        ...
        <!--</div>-->
            ...
            <a href="<?php echo base_url("producto_precios"); ?>" target="_blank" style="width: 70px; margin-right: 1px; margin-top: 1px" class="btn btn-primary btn-flickr" data-toggle="modal" ><font size="5" title="Modificar precios"><span class="fa fa-chrome"></span></font><br><small>Modif. Prec.</small></a>
        <?php
            if($rol[106-1]['rolusuario_asignado'] == 1){ ?>
            <table hidden="true">
                <!--<tr>
