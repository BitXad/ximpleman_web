    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Editar Botón Slide</h3>
            </div>
			<?php echo form_open('boton_slide/edit/'.$boton_slide['botonslide_id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="slide_id" class="form-control">
								...
								{
									$selected = ($slide['slide_id'] == $boton_slide['slide_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="boton_id" class="form-control">
								...
								{
									$selected = ($boton['boton_id'] == $boton_slide['boton_id']) ? ' selected="selected"' : "";
