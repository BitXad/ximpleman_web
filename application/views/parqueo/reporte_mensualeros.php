...
<script src="<?php echo base_url('resources/js/parqueo.js'); ?>" type="text/javascript"></script>
    ...
    <tr>
        ...
        <td style="width: 6cm; padding: 0; line-height: 10px;" > 
            <center>
                ...
                <font size="1" face="arial"><b>SUSCRIPCIONES MENSUALES</b></font> <br>
...
<div class="container no-print">
    <center>            
        ...
        <div class="col-md-2">
            ...
            <br>
            <button class="btn btn-sm btn-facebook btn-sm btn-block form-control"   onclick="buscar_mensualeros()">
                <!--<h4>-->
