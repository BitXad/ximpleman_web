          		...
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="unidad_nombre" value="<?php echo $this->input->post('unidad_nombre'); ?>" onKeyUp="this.value = this.value.toUpperCase();" class="form-control" id="unidad_nombre" required />
