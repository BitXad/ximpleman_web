...
<script src="<?php echo base_url('resources/js/inventario_sucursal.js'); ?>"></script>
...
<input type="hidden" name="losalmacenes" id="losalmacenes" value='<?php echo json_encode($almacenes); ?>' />
    ...
    <tr>
        ...
        <td style="width: 6cm; padding: 0" > 
            <center>
                ...
                <br><br>
                <font size="3" face="arial"><b>INVENTARIO DE SUCURSALES</b></font> <br>
