...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="input-group no-print">
            ...
            <input id="filtrar" type="text" class="form-control" placeholder="Ingrese usuario o destino">
        </div>
                ...
                <table class="table table-striped table-condensed" id="mitabla">
                    ...
                    <tbody class="buscar">
                        ...
                        <tr>
                            ...
                            <td class="no-print">
                                <!-- Botón Editar -->
                                <a href="<?php echo site_url('usuario_destino/edit/'.$u['usuariodestino_id']); ?>" class="btn btn-info btn-xs" title="Editar">
                                    <span class="fa fa-pencil"></span>
                                </a>

                                <!-- Botón Eliminar con modal -->
                                <a class="btn btn-danger btn-xs" data-toggle="modal" data-target="#myModal<?php echo $u['usuariodestino_id']; ?>">
                                    <span class="fa fa-trash"></span>
                                </a>

                                <div class="modal fade" id="myModal<?php echo $u['usuariodestino_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel<?php echo $u['usuariodestino_id']; ?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h3><b><span class="fa fa-trash"></span></b>
                                                    ¿Desea eliminar el destino <b><?php echo $u['destino_nombre']." asignada a: ".$u['usuario_nombre']; ?></b>?
                                                </h3>
                                            </div>
                                            <div class="modal-footer aligncenter">
                                                <a href="<?php echo site_url('usuario_destino/remove/'.$u['usuariodestino_id']); ?>" class="btn btn-success">
