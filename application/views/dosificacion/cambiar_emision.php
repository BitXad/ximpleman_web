    ...
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-header with-border">
                <h1 class="box-title"><b>CAMBIAR DOCUMENTO SECTOR</b></h1>
            </div>
            
            
            <?php echo form_open_multipart('dosificacion/cambiar_emision/'.$dosificacion['dosificacion_id']); ?>
            <div class="box-body">
...
<!--                            <input type="hidden" id="dosificacion_leyenda5_select" name="dosificacion_leyenda5_select" value="<?php echo ($this->input->post('dosificacion_leyenda5') ? $this->input->post('dosificacion_leyenda5') : $dosificacion['dosificacion_leyenda5']); ?>" class="form-control"/>
            ...
            <div class="box-footer">
            	...
            	<button type="submit" class="btn btn-success"  >
                    <i class="fa fa-check"></i> Cambiar</button>
<!--                <button class="btn btn-danger" onclick="cerrar(){ window.close(); }">
                    <i class="fa fa-check"></i> Cerrar
                </button>-->

                <a href="<?php echo site_url('venta/ventas'); ?>" class="btn btn-danger" onclick="cerrarVentana()">
...
//                $("#dosificacion_leyenda5").html(htmlLeyenda5); 
    ...
    function cerrarVentana() {
        if (window.opener) {
                  window.opener.location.reload(); // Recarga la ventana anterior
                  window.close(); // Cierra la ventana actual
              } else {
                  window.close(); // Cierra la ventana actual
                  //alert("No se pudo encontrar la ventana anterior.");
              }
    }
</script>