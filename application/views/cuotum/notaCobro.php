...
<div style="float:left; width:22%;">
    <table id="izquierdatabla">
    		<tr>
                <td>TOTAL CREDITO:</td><td style="width: 22px;"><?php echo $cuota[0]['credito_monto']; ?></td>
                <td>AMORTIZADO:</td><td style="width: 22px;"><?php echo $cuota[0]['credito_monto']-$cuota[0]['cuota_saldo']; ?></td>
            </tr>
            <tr>
...
<div style="float:left; width:70%;">
        <table id="derechatabla">
        	<tr>
                <td>TOTAL CREDITO: <?php echo $cuota[0]['credito_monto']; ?></td><td></td>
                <td>AMORTIZADO: <?php echo $cuota[0]['credito_monto']-$cuota[0]['cuota_saldo']; ?></td>
            </tr>
             <tr>
