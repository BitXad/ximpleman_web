			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="cuota_interes" value="<?php echo ($this->input->post('cuota_interes') ? $this->input->post('cuota_interes') : $cuotum['cuota_interes']); ?>" class="form-control" id="cuota_interes" readonly/>
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="cuota_saldo" value="<?php echo ($this->input->post('cuota_saldo') ? $this->input->post('cuota_saldo') : $cuotum['cuota_saldo']); ?>" class="form-control" id="cuota_saldo" readonly/>
						</div>
					</div>
					<div class="col-md-6">
