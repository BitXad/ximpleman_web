...
<!-------------------------------------------------------->
 ...
 <div class="box-tools" >
    <font size="3"><b>COMPRA No.: </b><?php echo $cuota[0]['compra_id']; ?></font><br>
    ...
    <div class="panel panel-primary col-md-12" >
        <h5><b>PROVEEDOR: </b><?php echo $cuota[0]['proveedor_nombre'];?>
...
<div class="box-header no-print">
                <h3 class="box-title  no-print">Detalle compra</h3>
                <!--<div class="box-tools  no-print">
                    <a href="<?php //echo site_url('detalle_compra/add'); ?>" class="btn btn-success btn-sm">+ A«Ðadir</a> 
                </div>-->
</div>
    ...
    <div class="col-md-12">
        <!--------------------- parametro de buscador --------------------->
                  <div class="input-group  no-print"> <span class="input-group-addon">Buscar</span>
                    <input id="filtrar" type="text" class="form-control" placeholder="Ingrese el codigo, compra, precio">
                  </div>
