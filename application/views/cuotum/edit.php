			...
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="credito_id" class="form-control">
								...
								{
									$selected = ($credito['credito_id'] == $cuotum['credito_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="cuota_capital" value="<?php echo ($this->input->post('cuota_capital') ? $this->input->post('cuota_capital') : $cuotum['cuota_capital']); ?>" class="form-control" id="cuota_capital" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cuota_interes" class="control-label">Interes</label>
						<div class="form-group">
							<input type="text" name="cuota_interes" value="<?php echo ($this->input->post('cuota_interes') ? $this->input->post('cuota_interes') : $cuotum['cuota_interes']); ?>" class="form-control" id="cuota_interes" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cuota_moradias" class="control-label">Mora Días</label>
						<div class="form-group">
							<input type="text" name="cuota_moradias" value="<?php echo ($this->input->post('cuota_moradias') ? $this->input->post('cuota_moradias') : $cuotum['cuota_moradias']); ?>" class="form-control" id="cuota_moradias" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cuota_multa" class="control-label">Multa</label>
						<div class="form-group">
							<input type="text" name="cuota_multa" value="<?php echo ($this->input->post('cuota_multa') ? $this->input->post('cuota_multa') : $cuotum['cuota_multa']); ?>" class="form-control" id="cuota_multa" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cuota_subtotal" class="control-label">Subtotal</label>
						<div class="form-group">
							<input type="text" name="cuota_subtotal" value="<?php echo ($this->input->post('cuota_subtotal') ? $this->input->post('cuota_subtotal') : $cuotum['cuota_subtotal']); ?>" class="form-control" id="cuota_subtotal" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cuota_descuento" class="control-label">Descuento</label>
						<div class="form-group">
							<input type="text" name="cuota_descuento" value="<?php echo ($this->input->post('cuota_descuento') ? $this->input->post('cuota_descuento') : $cuotum['cuota_descuento']); ?>" class="form-control" id="cuota_descuento" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cuota_total" class="control-label">Total</label>
						<div class="form-group">
							<input type="text" name="cuota_total" value="<?php echo ($this->input->post('cuota_total') ? $this->input->post('cuota_total') : $cuotum['cuota_total']); ?>" class="form-control" id="cuota_total" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cuota_fechalimite" class="control-label">Fecha Limite</label>
						<div class="form-group">
							<input type="text" name="cuota_fechalimite" value="<?php echo ($this->input->post('cuota_fechalimite') ? $this->input->post('cuota_fechalimite') : $cuotum['cuota_fechalimite']); ?>" class="form-control" id="cuota_fechalimite" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cuota_cancelado" class="control-label">Cancelado</label>
						<div class="form-group">
							<input type="text" name="cuota_cancelado" value="<?php echo ($this->input->post('cuota_cancelado') ? $this->input->post('cuota_cancelado') : $cuotum['cuota_cancelado']); ?>" class="form-control" id="cuota_cancelado" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="cuota_saldo" value="<?php echo ($this->input->post('cuota_saldo') ? $this->input->post('cuota_saldo') : $cuotum['cuota_saldo']); ?>" class="form-control" id="cuota_saldo" />
						</div>
					</div>
					<div class="col-md-6">
