    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Añadir Menu</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="menup_id" class="form-control">
								...
								{
									$selected = ($menu_principal['menup_id'] == $this->input->post('menup_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="menu_nombre" value="<?php echo $this->input->post('menu_nombre'); ?>" class="form-control" id="menu_nombre" required />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="menu_tipo" value="<?php echo $this->input->post('menu_tipo'); ?>" class="form-control" id="menu_tipo" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="menu_descripcion" class="control-label">Descripción</label>
						<div class="form-group">
							<input type="text" name="menu_descripcion" value="<?php echo $this->input->post('menu_descripcion'); ?>" class="form-control" id="menu_descripcion" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="menu_enlace" class="control-label">Enlace</label>
						<div class="form-group">
							<input type="text" name="menu_enlace" value="<?php echo $this->input->post('menu_enlace'); ?>" class="form-control" id="menu_enlace" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="menu_imagen" class="control-label">Imagen</label>
						<div class="form-group">
							<input type="text" name="menu_imagen" value="<?php echo $this->input->post('menu_imagen'); ?>" class="form-control" id="menu_imagen" />
						</div>
					</div>
				</div>
			</div>
