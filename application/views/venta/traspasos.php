...
<script src="<?php echo base_url('resources/js/traspasos.js'); ?>" type="text/javascript"></script>
...
<h3 class="box-title">Traspasos</h3>
            	<div class="box-tools">                    
                    ...
                    <select  class="btn btn-facebook btn-sm" id="select_ventas" onchange="buscar_traspasos()">
<!--                        <option value="1">-- SELECCIONE UNA OPCION --</option>-->
                        <option value="1">Traspasos de Hoy</option>
                        <option value="2">Traspasos de Ayer</option>
                        <option value="3">Traspasos de la semana</option>
                        <option value="4">Todos los traspasos</option>
                        <option value="5">Traspasos por fecha</option>
                        <option value="6">Traspasos Perdidas/Sin Detalle</option>
                    </select>
                    <?php } ?>

                    <a href="<?php echo site_url('venta/ventas'); ?>" class="btn btn-success btn-sm"><span class="fa fa-cart-arrow-down"></span> Traspasos/Ventas</a>
