...
<input type="text" id="docsec_codigoclasificador" value="<?php echo $dosificacion['docsec_codigoclasificador']; ?>" name="docsec_codigoclasificador"  true>
<input type="text" id="dosificacion_documentosector" value="<?php echo $dosificacion['dosificacion_documentosector']; ?>" name="dosificacion_documentosector"  true>
