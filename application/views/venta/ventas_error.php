...
<!--------------------- fin cliente_id --------------------->
        ...
        <div class="col-md-2" <?= $estilo_div ?> <?= ($parametro['parametro_documentoslista']==1)?"":"hidden" ?>>
            <label for="tipo_doc_identidad" class="control-label" style="margin-bottom: 0; font-size: 12px; color: gray; font-weight: normal">TIPO DOCUMENTO IDENTIDAD</label>
            <div class="col-md-6 form-group" <?= $estilo_div ?>>
...
<?php //if($es_movil == 0){ ?> 
        ...
        <div class="col-md-6 form-group" <?php echo $estilo_div; ?>>
...
<!---------------------- collapse ----------------------------->
    ...
    <div id="collapse1" class="panel-collapse collapse">
        ...
        <div class="col-md-3" <?php echo $estilo_div; ?>>
            <label for="cliente_departamento" class="control-label" style="margin-bottom: 0;"><?php echo ($dosificacion[0]["docsec_codigoclasificador"] == 3)?"PUERTO DESTINO":"DEPARTAMENTO";  ?></label>
            <div class="col-md-6 form-group" <?php echo $estilo_div; ?>>
        ...
        <div class="col-md-3" <?php echo $estilo_div; ?>>
            <label for="zona_id" class="control-label" style="margin-bottom: 0;"><?php echo ($dosificacion[0]["docsec_codigoclasificador"] == 3)?"LUGAR DESTINO/PAIS":"ZONA";  ?></label>
            <div class="col-md-6 form-group" <?php echo $estilo_div; ?>>
    ...
    <div class="col-md-<?php echo (12 - $parametro['parametro_anchobuscador']); ?>" id="divventas0" style="display:block;">
        ...
        ** <b style="color: red">COMANDA Nº </b><input type="text" style="border: none; color: red; font-weight: bolder; font-size: 16px ;" id="pedido_id" size="2" value="<?php echo isset($pedido[0]["pedido_id"])?$pedido[0]["pedido_id"]:0;  ?>" name="pedido_id" disabled="true">
        ...
        <div class="row">
            ...
            <!--------------- botones ---------------------->
            <?php if($dosificacion[0]['docsec_codigoclasificador']){ ?>
...
<!--            <button onclick='quitartodo()' class='btn btn-default btn-xs'><span class='fa fa-trash'></span><b> Vaciar</b></button> -->
            ...
            <div class="col-md-6" style="background-color: black; line-height: 15px;" <?php echo ($parametro["parametro_preciototal"]!=1)?"hidden":"" ?>>
                <center>
...
<?php 
    ...
    $efectivo = $subtotal;
    $cambio = $moneda["moneda_codigoclasificador"]; //tipo cambio documento sector == 3
    $ancho_boton = 10;
    ?>
...
Gasto de Seguro:2000
                ...
                <div class="col-md-6 form-group">
                  ...
                  <input type="number" step="0.0000000000000001" class="form-control" name="datos_totalgastosnacionalesfob" id="datos_totalgastosnacionalesfob">
                </div>
...
Gasto de Seguro:2000
                ...
                <div class="col-md-6 form-group">
                  ...
                  <input type="number" step="0.0000000000000001" class="form-control" name="datos_totalgastosinternacionales" value="0.00" id="datos_totalgastosinternacionales">
                </div>

                <div class="col-md-6 form-group">
                  <label for="datos_codigomoneda">Código Moneda</label>
                  <select class="form-control" name="datos_codigomoneda" value="1" id="datos_codigomoneda">
                      <?php foreach($monedas as $mon){ ?>
                      
                      <option value="<?php echo $mon["moneda_codigoclasificador"]; ?>"><?php echo $mon["moneda_descripcion"]." - ".$mon["moneda_nombre"]; ?></option>
                      <?php } ?>
                ...
                <div class="col-md-6 form-group">
                  ...
                  <textarea class="form-control" name="datos_descripcionpaquetes" value="10 PAQUETES DE MEDIO QUINTAL" id="datos_descripcionpaquetes"></textarea>
                </div>

                <div class="col-md-6 form-group">
                  <label for="datos_informacionadicional">Información Adicional</label>
                  <textarea class="form-control" name="datos_informacionadicional" value="CUENTA DE BANCO: 1-12542-212174" id="datos_informacionadicional"></textarea>
                </div>
