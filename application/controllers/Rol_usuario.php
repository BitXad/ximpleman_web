...
class Rol_usuario extends CI_Controller{
    ...
    function remove($id_rol_usuario)
    {
        $rol_usuario = $this->Rol_usuario_model->get_rol_usuario($id_rol_usuario);
            ...
            $sql = "DELETE u FROM rol_usuario u, rol r 
            WHERE (u.rol_id=r.rol_id AND u.tipousuario_id=".$tipousuario_id." AND r.rol_idfk=".$rol_id.") 
            OR (u.rol_id=".$rol_id." AND u.tipousuario_id=".$tipousuario_id.")";
            //$this->db->where_in('rol_id', 'tipousuario_id', array($sql));
         $this->db->query($sql);
          //$this->Rol_usuario_model->delete_rol_usuario($rol_usuario);
