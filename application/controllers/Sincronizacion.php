...
class Sincronizacion extends CI_Controller{
    ...
    function sincronizar_datos(){
        ...
        if($this->input->is_ajax_request()){
            ...
            if (($this->dosificacion["docsec_codigoclasificador"]==2)||($this->dosificacion["docsec_codigoclasificador"]==39)||($this->dosificacion["docsec_codigoclasificador"]==8)||($this->dosificacion["docsec_codigoclasificador"]==12))
            {
