    ...
    */
    ...
    function generar_factura()
    {
        ...
        //**************** inicio contenido ***************        
            ...
            $params = array(
                'dosificacion_numfact' => $factura_numero,
            );
            $this->Servicio_model->update_dosificacion(1,$params);
            
            $paramsf = array(
                'estado_id' => $estado_id,
                'venta_id' => $venta_id,
                'factura_fechaventa' => $factura_fechaventa,
                'factura_fecha' => $factura_fecha,
                'factura_hora' => $factura_hora,
                'factura_subtotal' => $factura_subtotal,
                'factura_ice' => $factura_ice,
                'factura_exento' => $factura_exento,
                'factura_descuento' => $factura_descuento,
                'factura_total' => $factura_total,
                'factura_numero' => $factura_numero,
                'factura_autorizacion' => $factura_autorizacion,
                'factura_llave' => $factura_llave,
                'factura_fechalimite' => $factura_fechalimite,
                'factura_codigocontrol' => $factura_codigocontrol,
                'factura_leyenda1' => $factura_leyenda1,
                'factura_leyenda2' => $factura_leyenda2,
                'factura_nit' => $factura_nit,
                'factura_razonsocial' => $factura_razonsocial,
                'factura_nitemisor' => $factura_nitemisor,
            ...
            $paramsdf = array(
                ...
                'detallefact_codigo' => $detallefact_codigo,
                'detallefact_unidad' => $unidad,
                'detallefact_cantidad' => $detallefact_cantidad,
                'detallefact_descripcion' => $detallefact_descripcion,
                'detallefact_precio' => $detallefact_precio,
                'detallefact_subtotal' => $detallefact_subtotal,
                'detallefact_descuento' => $detallefact_descuento,
                'detallefact_total' => $detallefact_total,
                'detallefact_preferencia' => $detallefact_preferencia,
                'detallefact_caracteristicas' => $detallefact_caracteristicas,
            );
            $detallefact_id = $this->Servicio_model->add_detallefact($paramsdf);
            
            $paramstd = array(
                'factura_id' => $factura_id,
                'documento_respaldo_id' => 1,
            );
            $this->Servicio_model->update_servicio($servicio_id,$paramstd);
